    ...
    d.ValueAxis = d.Class({
            ...
            if (this.synchronizationMultiplier && this.synchronizeWith)
                ...
                (this.fullMin = this.min),
                    ...
                    "date" == this.type &&
                        ...
                        this.strictMinMax && (this.minimumDate && (this.fullMin = this.minimumDate.getTime()), this.maximumDate && (this.fullMax = this.maximumDate.getTime())));
        },
        draw: function () {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0;
                ...
                !0 === g
                    ? ((z = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E),
                      ...
                      z > this.logGridLimit && ((r = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1), (t = Math.round(Math.log(this.minReal) * Math.LOG10E)), r > this.gridCountR && (p = Math.ceil(r / this.gridCountR))))
            ...
            if (f)
                return (
                    ...
                    e
                        ...
                        : (g &&
                              ((e = String(a).split(".")),
                              e[1] ? ((f.precision = e[1].length), 0 > c && (f.precision = Math.abs(c)), b && 1 < a && (f.precision = 0), b || isNaN(this.precision) || (f.precision = this.precision)) : (f.precision = -1)),
                ...
                for (q = 0; q < k.length; q++)
                    if (((n = k[q]), n.hidden)) n.newStack && ((g[p] = NaN), (e[p] = NaN));
                        ...
                        if (((m = this.data[p].axes[this.id].graphs[n.id]), (h = m.values.value), isNaN(h))) n.newStack && ((g[p] = NaN), (e[p] = NaN));
                            ...
                            "regular" == b &&
                                (r &&
                                    (isNaN(c[p]) ? ((c[p] = h), (m.values.close = h), (m.values.open = this.baseValue)) : (isNaN(h) ? (m.values.close = c[p]) : (m.values.close = h + c[p]), (m.values.open = c[p]), (c[p] = m.values.close))),
                                "column" == a &&
                                    (n.newStack && ((g[p] = NaN), (e[p] = NaN)),
                                    (m.values.close = h),
                                    0 > h
                                        ? ((m.values.close = h), isNaN(e[p]) ? (m.values.open = t) : ((m.values.close += e[p]), (m.values.open = e[p])), (e[p] = m.values.close))
                                        : ((m.values.close = h), isNaN(g[p]) ? (m.values.open = t) : ((m.values.close += g[p]), (m.values.open = g[p])), (g[p] = m.values.close))));
                        }
            }
        ...
        getMinMax: function () {
            ...
            this.logarithmic &&
                (2 < Math.log(b) * Math.LOG10E - Math.log(a) * Math.LOG10E
                    ? ((this.minReal = this.min = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E))), (this.maxReal = this.max = Math.pow(10, Math.ceil(Math.log(Math.abs(b)) * Math.LOG10E))))
                    : ((a = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)) / 10), Math.pow(10, Math.floor(Math.log(Math.abs(this.min)) * Math.LOG10E)) / 10 < a && (this.minReal = this.min = 10 * a)));
        },
        ...
        getCoordinate: function (a, b) {
            ...
            var c = this.rotate,
                ...
                k = this.minReal;
            !0 === this.logarithmic
                ? (0 === a && (a = this.treatZeroAs), (h = Math.log(a) * Math.LOG10E - Math.log(k) * Math.LOG10E), (c = c ? (!0 === e ? d - f * h : f * h) : !0 === e ? f * h : d - f * h))
    ...
    d.RecAxis = d.Class({
        construct: function (a) {
            var b = a.chart,
                ...
                p = b.container;
            "H" == a.orientation
                ? ((e = d.line(p, [0, q], [0, 0], e, g, c)), (this.axisWidth = a.width), "bottom" == a.position ? ((k = c / 2 + f + n + m - 1), (c = l)) : ((k = -c / 2 - f + m + k), (c = h + l)))
                : ((this.axisWidth = a.height),
                  "right" == a.position ? ((e = d.line(p, [0, 0, -h], [0, n, n - k], e, g, c)), (k = m + k), (c = c / 2 + f + h + q + l - 1)) : ((e = d.line(p, [0, 0], [0, n], e, g, c)), (k = m), (c = -c / 2 - f + l)));
            e.translate(c, k);
            c = b.container.set();
            c.push(e);
            b.axesSet.push(c);
                ...
                if (
                    ...
                    "bottom" == Z
                        ...
                        : ((v += na + r / 2 - ea),
                          (G += ma),
                          J
                              ? (0 < n ? ((v = (ha / 2) * Math.sin(V) + B + 3), a.centerRotatedLabels || (G -= (ha / 2) * Math.cos(V))) : (v += B + 3), (v += aa))
                              : (0 < n ? ((v = -(ha / 2) * Math.sin(V) - B - 6), a.centerRotatedLabels || (G += (ha / 2) * Math.cos(V))) : (v -= B + r + 3 + u + 3), (v -= aa))),
    ...
    d.AmGraph = d.Class({
        ...
        draw: function () {
            ...
            if (a.drawGraphs) {
                isNaN(this.precision) ||
                    (this.numberFormatter ? (this.numberFormatter.precision = this.precision) : (this.numberFormatter = { precision: this.precision, decimalSeparator: a.decimalSeparator, thousandsSeparator: a.thousandsSeparator }));
                var c = a.container;
                this.container = c;
                this.destroy();
                var e = c.set();
        ...
        createSerialGraph: function () {
            ...
            if (!(J || ("line" != h && "smoothedLine" != h && "step" != h) || (1 == e.length && "step" != h && "none" == this.bullet && ((this.bullet = "round"), (this.resetBullet = !0)), (!Ra && void 0 == Ja) || m))) {
                ...
                t
                    ? ((ha = q), (Qa = Math.abs(Mb - Ka)), (ub = q), (vb = Math.abs(nb - Ka)), (mb = tb = 0), f.reversed ? ((ca = 0), (lb = Ka)) : ((ca = Ka), (lb = 0)))
                    : ((Qa = n), (ha = Math.abs(Mb - Ka)), (vb = n), (ub = Math.abs(nb - Ka)), (lb = ca = 0), f.reversed ? ((mb = p), (tb = Ka)) : (mb = Ka));
            }
            var La = Math.round;
            this.pmx = La(ca);
            this.pmy = La(tb);
                            ...
                            if (isNaN(W)) z || (this.drawLineGraph(x, u, T, U), (x = []), (u = []), (T = []), (U = []));
                                ...
                                if (Va || (void 0 != v.lineColor && v.lineColor != this.lineColorSwitched) || (void 0 != v.fillColors && v.fillColors != this.fillColorsSwitched) || !isNaN(v.dashLength))
                                    this.drawLineGraph(x, u, T, U),
                                        ...
                                        !Ma || isNaN(N) || isNaN(O) || (T.push(O), U.push(N)),
                                        m
                                            ? (Sa ? ((this.lineColorSwitched = xa), (this.fillColorsSwitched = wb)) : ((this.lineColorSwitched = Ja), (this.fillColorsSwitched = Ra)),
                                              void 0 === this.bulletColor && (this.bulletColorSwitched = xa))
                                            : ((this.lineColorSwitched = v.lineColor), (this.fillColorsSwitched = v.fillColors), void 0 === this.bulletColor && (this.bulletColorSwitched = this.lineColorSwitched)),
                                        (this.dashLengthSwitched = v.dashLength);
                            ...
                            if (!isNaN(W)) {
                                t
                                    ? (isNaN(A) || (x.push(A), u.push(F - wa)),
                                      ...
                                      u.push(F + Ga),
                                      x.push(E),
                                      !Ma || isNaN(N) || isNaN(O) || (isNaN(B) || (T.push(B), U.push(N - wa)), T.push(O), U.push(N - wa), T.push(O), U.push(N + Ga)))
                                    : (isNaN(y) || (u.push(y), x.push(E - wa)),
                                      x.push(E - wa),
                                      u.push(F),
                                      x.push(E + Ga),
                                      u.push(F),
                                      !Ma || isNaN(N) || isNaN(O) || (isNaN(D) || (T.push(O - wa), U.push(D)), T.push(O - wa), U.push(N), T.push(O + Ga), U.push(N)));
                                A = E;
                                y = F;
                                B = O;
                                D = N;
        ...
        drawLineGraph: function (a, b, c, e) {
            ...
            if (1 < a.length) {
                ...
                void 0 === z ||
                    ...
                    ((p = d.line(l, a, b, z, r, p, x, !1, !1, f)), p.node.setAttribute("stroke-linejoin", "round"), d.setCN(k, p, g.bcn + "stroke"), d.setCN(k, p, g.bcn + "stroke-negative"), n.push(p));
                if (0 < h || 0 < A)
                    if (
                        ((p = a.join(";").split(";")),
                        (r = b.join(";").split(";")),
                        ...
                        "serial" == q || "radar" == q
                            ...
                            : "xy" == q &&
                              ...
                              "H" == b.orientation
                                  ? ((y = "top" == b.position ? 0 : b.height), p.push(p[p.length - 1]), r.push(y), p.push(p[0]), r.push(y), p.push(a[0]), r.push(r[0]))
                                  : ((y = "left" == b.position ? 0 : b.width), r.push(r[r.length - 1]), p.push(y), r.push(r[0]), p.push(y), r.push(r[0]), p.push(p[0]))),
            ...
            if (1 < a.length) {
                ...
                0 < q &&
                    ...
                    0 < c.length
                        ...
                        : (this.rotate ? ((p += " L" + x + "," + b[b.length - 1]), (p += " L" + x + "," + b[0])) : ((p += " L" + a[a.length - 1] + "," + x), (p += " L" + a[0] + "," + x)), (p += " L" + a[0] + "," + b[0])),
            ...
            if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
                ...
                l &&
                    ...
                    "function" == typeof l
                        ? ((l = new l()),
                          (l.chart = e),
                          a.bulletConfig && ((l.availableSpace = c), (l.graph = this), (l.graphDataItem = a), (l.bulletY = c), (a.bulletConfig.minCoord = this.minCoord - c), (l.bulletConfig = a.bulletConfig)),
                          l.write(g),
                        ...
                        ? ((e = f.getBalloonColor(this, a)),
                          ...
                          isNaN(b) || isNaN(g)
                              ...
                              : ((a = this.width),
                                ...
                                h.fixPrevious(),
                                h.fixedPosition && (c = !1),
                                !c && "radar" != f.type && (b < k - 0.5 || b > a + k || g < l - 0.5 || g > q + l) ? (h.showBalloon(m), h.hide(0)) : (h.followCursor(c), h.showBalloon(m))))
    ...
    d.ChartCursor = d.Class({
        ...
        hideCursor: function (a) {
            ...
            (this.chart.wasTouched && this.leaveAfterTouch) ||
                this.isHidden ||
                this.leaveCursor ||
                (this.hideCursorReal(), a ? this.chart.handleCursorHide() : this.fire({ target: this, chart: this.chart, type: "onHideCursor" }), this.chart.setMouseCursor("auto"));
        },
        ...
        handleMouseDown: function () {
            ...
            if (this.mouseIsOver())
                if (((this.mouseIsDown = !0), (this.mouseX0 = this.mouseX), (this.mouseY0 = this.mouseY), (this.mouse2X0 = this.mouse2X), (this.mouse2Y0 = this.mouse2Y), this.drawing))
                    ...
                    (this.dispatchMovedEvent(this.mouseX, this.mouseY), !this.pan && isNaN(this.mouse2X0) && (isNaN(this.fx) || (this.mouseX0 = this.fx), isNaN(this.fy) || (this.mouseY0 = this.fy)), this.hZoomEnabled || this.vZoomEnabled)
                ) {
                    this.zooming = !0;
        ...
        syncWithCursorReal: function (a, b) {
            ...
            var d = a.mouseX,
                f = a.mouseY;
            this.rotate
                ? ((d = NaN), this.vvLine && this.vvLine.hide(), this.hhLine && e && (isNaN(a.fy) ? this.hhLine.translate(0, a.mouseY) : this.fixHLine(a.fy, 0)))
                : ((f = NaN), this.hhLine && this.hhLine.hide(), this.vvLine && c && (isNaN(a.fx) ? this.vvLine.translate(a.mouseX, 0) : this.fixVLine(a.fx, 0)));
...
(function () {
    ...
    d.SimpleChartScrollbar = d.Class({
        ...
        updateDragIconPositions: function () {
            ...
            this.rotate
                ? ((f = this.dragIconWidth), (h = this.dragIconHeight), e.translate((k - h) / 2, c - f / 2), d.translate((k - h) / 2, c + a.height - f / 2))
                : ((f = this.dragIconHeight), (h = this.dragIconWidth), e.translate(b - h / 2, (k - f) / 2), d.translate(b - h / 2 + a.width, (k - f) / 2));
        },
        ...
        init: function () {
            ...
            a ||
                ("CategoryAxis" == this.gridAxis.cname
                    ...
                    : ((a = new d.ValueAxis()), (a.data = b.chartData), (a.id = c.id), (a.type = c.type), (a.maximumDate = c.maximumDate), (a.minimumDate = c.minimumDate), (a.minPeriod = c.minPeriod), (a.minMaxField = c.minMaxField)),
                (this.categoryAxis = a));
            a.chart = b;
        ...
        zoomScrollbar: function (a) {
            if ((!(this.dragging || this.resizingLeft || this.resizingRight || this.animating) || a) && this.dragger && this.enabled) {
                ...
                g.parseDates && !g.equalSpacing
                    ...
                    : (a[this.start] && (b = a[this.start].x[g.id]), a[this.end] && (c = a[this.end].x[g.id]), (a = g.stepWidth), g.startOnAxis || ((d = a / 2), (b -= d), (c += d)));
                this.stepWidth = a;
        ...
        draw: function () {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    "H" != x
                        ? ((D = a - C / 2), b < k + A + 10 && "down" != x ? ((Q = !0), e && (b += y), (y = b + z), (this.deltaSignY = -1)) : (e && (b -= y), (y = b - A - z), (this.deltaSignY = 1)))
                        : (2 * z > A && (z = A / 2), (y = b - A / 2), a < h + (l - h) / 2 ? ((D = a + z), (this.deltaSignX = -1)) : ((D = a - C - z), (this.deltaSignX = 1)));
                    y + A >= m && (y = m - A);
                    y < k && (y = k);
                    D < h && (D = h);
                    D + C > l && (D = l - C);
                    ...
                    this.drop
                        ...
                        : ((t = []),
                          (u = []),
                          "H" != x
                              ? ((h = a - D), h > C - z && (h = C - z), h < z && (h = z), (t = [0, h - z, a - D, h + z, C, C, 0, 0]), (u = Q ? [0, 0, b - y, 0, 0, A, A, 0] : [A, A, b - y, A, A, 0, 0, A]))
                              : ((x = b - y),
                                x > A - z && (x = A - z),
                                x < z && (x = z),
    ...
    d.AmCoordinateChart = d.Class({
        ...
        parsePartSerialData: function (a, b, c, e) {
            ...
            for (u = b; u < c; u++) {
                ...
                if (
                    k &&
                    (m.categoryFunction ? (b = m.categoryFunction(b, D, m)) : (!A || b instanceof Date || (b = b.toString() + " |"), (b = d.getDate(b, A, m.minPeriod))),
    ...
    d.Image = d.Class({
        ...
        draw: function () {
            ...
            a.url
                ...
                : a.svgPath && ((c = b.path(a.svgPath)), c.setAttr("fill", a.color), c.setAttr("stroke", a.outlineColor), (b = c.getBBox()), (d = Math.min(a.width / b.width, a.height / b.height)));
            c &&
...
(function () {
    ...
    d.wedge = function (a, b, c, e, g, f, h, k, l, m, n, q, p, t) {
        ...
        if (0 < l) {
            P = " M" + x + "," + (A + l) + " L" + y + "," + (B + l);
            z
                ? (M || (P += " A" + (b - f) + "," + (l + c - h) + "," + (b + f) + "," + (l + c + h) + "," + y + "," + (B + l) + "," + D + "," + (C + l)),
                  (P += " L" + I + "," + (u + l)),
                  0 < k && (M || (P += " B" + (b - k) + "," + (l + c - w) + "," + (b + k) + "," + (l + c + w) + "," + I + "," + (l + u) + "," + x + "," + (l + A))))
        ...
        z
            ? (M || (g = " A" + r(b - f) + "," + r(c - h) + "," + r(b + f) + "," + r(c + h) + "," + r(y) + "," + r(B) + "," + r(D) + "," + r(C)), (h = " M" + r(x) + "," + r(A) + " L" + r(y) + "," + r(B) + g + " L" + r(I) + "," + r(u)))
    ...
    d.VMLRenderer = d.Class({
        ...
        setAttr: function (a, b, c) {
            if (void 0 !== c) {
                ...
                "text" == f &&
                    ("text-anchor" == b &&
                        ((a.anchor = c), (k = g.clientWidth), "end" == c && (h.marginLeft = -k + "px"), "middle" == c && ((h.marginLeft = -(k / 2) + "px"), (h.textAlign = "center")), "start" == c && (h.marginLeft = "0px")),
                    "fill" == b && (h.color = c),
                ...
                if (e) {
                    ...
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e)
                        (m = q.set()),
                            ...
                            m.push(t),
                            a.bullet &&
                                (a.hidden || (f = a.bulletColorR), (t = d.bullet(q, a.bullet, a.bulletSize, f, a.bulletAlpha, a.bulletBorderThickness, k, a.bulletBorderAlpha))) &&
...
(function () {
    ...
    d.resetDateToMin = function (a, b, c, e) {
        ...
        var g, f, h, k, l, m, n;
        d.useUTC
            ? ((g = a.getUTCFullYear()), (f = a.getUTCMonth()), (h = a.getUTCDate()), (k = a.getUTCHours()), (l = a.getUTCMinutes()), (m = a.getUTCSeconds()), (n = a.getUTCMilliseconds()), (a = a.getUTCDay()))
            : ((g = a.getFullYear()), (f = a.getMonth()), (h = a.getDate()), (k = a.getHours()), (l = a.getMinutes()), (m = a.getSeconds()), (n = a.getMilliseconds()), (a = a.getDay()));
        switch (b) {
            case "YYYY":
                g = Math.floor(g / c) * c;
                f = 0;
    ...
    d.formatDate = function (a, b, c) {
        ...
        var e,
            ...
            q = d.getWeekNumber(a);
        d.useUTC
            ? ((e = a.getUTCFullYear()), (g = a.getUTCMonth()), (f = a.getUTCDate()), (h = a.getUTCDay()), (k = a.getUTCHours()), (l = a.getUTCMinutes()), (m = a.getUTCSeconds()), (n = a.getUTCMilliseconds()))
            : ((e = a.getFullYear()), (g = a.getMonth()), (f = a.getDate()), (h = a.getDay()), (k = a.getHours()), (l = a.getMinutes()), (m = a.getSeconds()), (n = a.getMilliseconds()));

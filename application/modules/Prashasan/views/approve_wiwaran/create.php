              ...
              <table class="table table-bordered" id="add_new_fields_jagga">
                ...
                <tbody>
                  <tr class="row_hakdar" id="row_hakdar_0">
                    <td><input type="text" name="bida_wiwaran[]" class="form-control" id="id_bida_wiwaran_0" value="" required=""></td>
                    <td><input type="text" name="jamma_din[]" class="form-control" id="id_jamma_din_name_0" value="" required=""></td>
                    <td><input type="text" name="kharcha[]" class="form-control" id="id_kharcha_0" value="" required=""></td>
                    <td><input type="text" name="baki[]" class="form-control" id="id_baki_0" value="" required=""></td>
                    <td><input type="text" name="remarks[]" class="form-control" id="id_remarks_0" value="" required=""></td>

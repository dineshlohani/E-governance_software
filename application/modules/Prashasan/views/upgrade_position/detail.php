    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item"><a href="<?=base_url()?>upgrade-position">स्तर वृद्धि सम्वन्धमा </a>
                </li>
                        ...
                        <div class="offset-lg-2 col-lg-8">
                            <table class="table table-bordered my-4">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>पदास्थापना मिति</td>
                                        <td>
                                            <?=$result->start_date?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>सतरवृद्धि अवधि</td>
                                        <td>
                                            <?=$result->period?>
                                        </td>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4" class="text-center" align="center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <a class="btn btn-warning  btn-submit btn-secondary mt-3" href="<?=  base_url()?>upgrade-position/edit/<?=$result->id?>" style="color:#000">
                                                        सम्पादन
                                                        गर्नुहोस्
                                                    </a>
                                                    <a class="btn btn-info  btn-submit btn-secondary mt-3" href="<?=  base_url()?>upgrade-position/darta/<?=$result->id?>" style="color:#000">
                                                        दर्ता गर्नुहोस
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <td colspan="4" class="text-center" align="center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <a class="btn btn-info  btn-submit btn-secondary mt-3" href="<?=  base_url()?>upgrade-position/chalani/<?=$result->id?>" style="color:#000">
                                                        चलानी गर्नुहोस
                                                    </a>
                                                </div>
                ...
                <div class="tab-pane fade <?php if($result->status != 1){ echo 'active show';}?>" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                    <div class="text-right">
                        <?php if($result->status == 3  ) : ?>
                            <?php echo form_open(base_url().'upgrade-position/print/'.$result->id ,'target="_blank"'); ?>
                    ...
                    <div class="letter">
                        ...
                        <div class="text-center font-28" style="margin-top: 70px; margin-bottom: 70px;">
                            <h4>
                                <span style="border-bottom: 1px solid black; margin-bottom: 5px;"> <span class="red"> बिषय : </span> स्तर वृद्धि सम्वन्धमा ।
                                </span>
                        ...
                        यस गाउँपालिका अन्तर्गत <b><?php echo $result->working_office?></b>मा <b><?php echo $result->position?> <?php echo $result->taha?></b> तहको पदमा कार्यरत <b><?php echo $result->gender .' '. $result->name ?></b> 

                        मिति <b>

                            <?php echo $result->from_date?></b> मा स्थायी नियूक्ति भई मिति <b><?php echo $result->start_date?></b> मा <b><?php echo $result->position?> <?php echo $result->taha?></b> तहको पदमा <b><?php echo $result->working_office?></b> पदस्थापन भई निरन्तर रुपमा सेवा गर्दै आएको र मिति <b><?php echo $result->period_date?></b> मा निजको सेवा अवधि <b><?php echo $result->period?></b> वर्ष पुरा भएकोले नियमानुसार <b><?php echo $result->upgrade_position?> <?php echo $result->upgrade_taha?></b> तहमा स्तरवृद्धिका लागि सिफारिस गरिएको व्यहोरा अनुरोध छ ।

    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item"><a href="<?=base_url()?>sawari-pass">स्थायी नियुक्ति पत्र</a>
                </li>
                            ...
                            <table class="table table-bordered my-4">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?=$result->from_date.' देखि '.$result->to_date?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>सवारी नं</td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4" class="text-center" align="center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <a class="btn btn-warning  btn-submit btn-secondary mt-3" href="<?=  base_url()?>sawari-pass/edit/<?=$result->id?>" style="color:#000">
                                                        सम्पादन
                                                        गर्नुहोस्
                                                    </a>
                                                    <a class="btn btn-info  btn-submit btn-secondary mt-3" href="<?=  base_url()?>sawari-pass/darta/<?=$result->id?>" style="color:#000">
                                                        दर्ता गर्नुहोस
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <td colspan="4" class="text-center" align="center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <a class="btn btn-info  btn-submit btn-secondary mt-3" href="<?=  base_url()?>sawari-pass/chalani/<?=$result->id?>" style="color:#000">
                                                        चलानी गर्नुहोस
                                                    </a>
                                                </div>
                ...
                <div class="tab-pane fade <?php if($result->status != 1){ echo 'active show';}?>" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                    <div class="text-right">
                        <?php if($result->status == 3  ) : ?>
                            <?php echo form_open(base_url().'sawari-pass/print/'.$result->id ,'target="_blank"'); ?>
                    ...
                    <div class="letter">
                        ...
                        <div class="text-center font-28" style="margin-top: 70px; margin-bottom: 70px;">
                            <h4>
                                <span style="border-bottom: 1px solid black; margin-bottom: 5px;"> <span class="red"> बिषय : </span> सवारी पास उपलब्ध गराईदिने सम्वन्धमा  ।
                                </span>
                        ...
                        <div class="text-justify" style="margin-top: 10px; text-indent: 150px;">
                           ...
                           प्रस्तुत विषयमा यस कार्यालयका प्रमुख प्रशासकीय अधिकृत <?php echo $result->name?> लगायत अन्य ब्यक्तिहरु कार्यालयको कामको सिलसिलामा <?php echo $result->destination?> सम्म जानुपर्ने भएकोले मिति <?php echo $result->from_date?> देखि मिति <?php echo $result->to_date?> गते सम्म आवतजावतका लागि देहाय बमोजिमको सवारी साधनलाई पास उपलब्ध गराईदिनुहुन आदेशानुसार अनुरोध छ ।  

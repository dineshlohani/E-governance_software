...
class Mdl_darta extends CI_Model
{
    /*------------------------------------------------------------------------------------------------------------------*/
    private $_tableName = "darta";
    /*------------------------------------------------------------------------------------------------------------------*/
...
//        $this->db->where('type="fox" OR type="dog"');
    ...
    /*------------------------------------------------------------------------------------------------------------------*/
    public function getAllByWard($ward, $by='darta_no', $order='desc')
    {
    ...
    /*------------------------------------------------------------------------------------------------------------------*/
    public function getAllByMuncipality($by='darta_no', $order='desc')
    {
        $this->db->order_by($by, $order);
   ...
   public function getReservedDartaNoByDate($date, $is_muncipality, $ward=0)
   {
    ...
    public function getFiscalYearEndDate() {
        ...
        $query = $this->db->get('fiscal_year_end_date');
    ...
    public function getNewData($start_date, $date) {
        $this->db->select('count(id) as Total')->from('darta');
        $this->db->where('nepali_darta_miti <=', $date);
        $this->db->where('nepali_darta_miti >=', $start_date);
        $query = $this->db->get();
       // if($query->num_rows() > 1){
            return $query->row();
        // } else {
    ...
    public function getNewMaxDartaNo($is_muncipality, $ward=0,$start_date =NULL, $date= NULL )
    {
        ...
        $sql .= "and nepali_darta_miti >= '".$start_date."'";
        $sql .= "and nepali_darta_miti <= '".$date."'";
        $query = $this->db->query($sql);

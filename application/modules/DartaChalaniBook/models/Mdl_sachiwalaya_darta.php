...
class Mdl_sachiwalaya_darta extends CI_Model
{
    /*------------------------------------------------------------------------------------------------------------------*/
    private $_tableName = "sachiwalaya_darta";
    /*------------------------------------------------------------------------------------------------------------------*/
...
//        $this->db->where('type="fox" OR type="dog"');
    ...
    /*------------------------------------------------------------------------------------------------------------------*/
    public function getByDartaNo($darta_no)
    {
        $query = $this->db->get_where($this->_tableName, array('darta_no' => $darta_no));

                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-10 col-12">
                                        <div class="date-content d-none" >
                                            <?php echo form_open(base_url().'darta-book', array('method'=>'get'));?>
                                            <div class="row">
                                                <div class="col-lg-9">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="dropdown-menu search" aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        href="<?= base_url()?>darta-book?month=3&submit=">पछिल्लो
                                                    तीन महिनाको</a>
                                                    <a class="dropdown-item"
                                                    href="<?= base_url()?>darta-book?month=6&submit=">पछिल्लो
                                                छ महिनाको</a>
                                                <a class="dropdown-item"
                                                href="<?= base_url()?>darta-book?month=12&submit=">पछिल्लो
                                            बाह्र महिनाको</a>
                        ...
                        <div class="search-form" >
                            <div class="col-12 col-lg-10 mb-2 mr-sm-2">
                                ...
                                <form id='id_search_form' method='GET' action='<?= base_url()?>darta-book' class="form-inline ">
...
<?php //if($this->session->userdata('is_muncipality')==1):?>
    <div class="text-right mb-3" >
        ...
        <a href="<?= base_url()?>darta-direct" class="btn btn-primary">नयाँ दर्ता</a>
        <a href="<?= base_url()?>maujuda-darta-book" class="btn btn-warning">मौजुदा सुची दर्ता किताब</a>
    </div>
<?php //endif;?>
        ...
        else
        {
            ...
            foreach($result as $data)
            {
                ...
                <tr>
                    ...
                    <td>
                        <?php if($this->session->userdata('is_sachib') == 0 && $this->session->userdata('mode') == 'superadmin'):?>
                        <a href="<?= base_url()?>darta-direct/<?= $data->id?>">
                            <i class="fa fa-edit fa-2x" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Edit"></i>
                        </a>
                    <?php endif;?>
                    <a href="<?= base_url()?>darta-book/detail/<?= $data->id?>">

...
<div class="row">
    ...
    <div class="col-lg-10 col-12">
        ...
        <?php echo form_open(base_url().'chalani-book', array('method'=>'get'));?>
        <div class="row">
            <div class="col-lg-9">
                ...
                <div class="dropdown mb-2 mr-sm-2">
                    ...
                    <div class="dropdown-menu search" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item"
                           href="<?= base_url()?>chalani-book?month=3&submit=">पछिल्लो
                            तीन महिनाको</a>
                        <a class="dropdown-item"
                           href="<?= base_url()?>chalani-book?month=6&submit=">पछिल्लो
                            छ महिनाको</a>
                        <a class="dropdown-item"
                           href="<?= base_url()?>chalani-book?month=12&submit=">पछिल्लो
                            बाह्र महिनाको</a>
...
<form id='id_search_form' method='GET' action='<?= base_url()?>chalani-book' class="form-inline ">
        ...
        <button class="btn ml-lg-2 reset btn-lg btn-secondary" type="button">Reset</button>
            ...
            <?php ///if($this->session->userdata('is_muncipality')==1):?>
                <div class="text-right mb-3" >
                    <a href="<?= base_url()?>chalani_book_excel" class="btn btn-info"><i class='fa fa-file-excel-o'></i> Export Excel</a>
                    <a href="<?= base_url()?>chalani-direct" class="btn btn-primary">नयाँ चलानी</a>
                ...
                <table class="table table-responsive-sm table-responsive-md">
                    ...
                    <tr>
                        ...
                        <th scope="col">पाउने कार्यालय वा व्यक्तिको विवरण</th>

                        ...
                        <div class="offset-lg-2 col-lg-8">
                            <table class="table table-bordered my-4">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            जग्गा मिलन गर्नुपर्ने क्षेत्रफल
                                        </td>
                                        <td>
                                            <?= $result->kittakat_area?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>घरको जम्मा क्षेत्रफल</td>
                                        <td><?= $result->ghar_area?></td>
                                    </tr>
                                    <tr>
                                        <td>घरको भुई तल्लाको क्षेत्रफल</td>
                                        <td><?= $result->first_floor_home_area ?></td>
                                    </tr>
                                    <tr>
                                        <td>पाउने फार</td>
                                        <td> <?= $result->paune_far ?> </td>
                                    </tr>
                                    <tr>
                                        <td>सिफारिस दिन मिल्ने कारण</td>
                                        <td><?= $result->reason ?> </td>
                                    </tr>
                                    <tr>
                                        <td>प्राबिधिकको नाम</td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div class="row">
                                               ...
                                               ?>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>kitta-kat-sifaris/edit/<?= $result->id ?>/">सम्पादन
                                                        गर्नुहोस्</a>
                                                </div>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>kitta-kat-sifaris/darta/<?= $result->id ?>/">
                                                        दर्ता गर्नुहोस</a>
                                                </div>
                                                <?php
                                                   }
                                               ...
                                               ?>
                                                ...
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>kitta-kat-sifaris/chalani/<?= $result->id ?>/">
                                                        चलानी गर्नुहोस</a>
                                                </div>
                                                <?php
                                                   }
                ...
                <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                    <div class="text-right">
                        <?php if($result->status == 3 ): ?>
                            <?php echo form_open(base_url().'kitta-kat-sifaris/print/'.$result->id ,'target="_blank"'); ?>
                    ...
                    <div class="letter_print">
                        <div class="letter-head">
                            ...
                            <div class="row">
                                <div class="col-3 letter-head-left">
                                    ...
                                    <span class="red"><?php echo $result->status?> पत्र संख्या: </span> <?= $current_session->name ?><br>
                        ...
                        <!-- ----------------------Modal End-------------- -->
                        <div class="text-center font-28" style="margin-bottom: 30px;">
                            <h4><span style="border-bottom: 1px solid black; margin-bottom: 5px;"> <span class="red"> बिषय :</span> कित्ताकाट सिफारिस।</span>
                            </h4>
                        </div>
                        ...
                        <div class="mt-3" style="line-height: 1.6">
                            ...
                            सिफारिस दिन मिल्ने कारण: <?= $result->reason ?> <br>
                        </div>
                        <div class="my-3">
                        
                        </div>
                        <div style="line-height: 2.3">
                            <b>  सिफारिस गर्ने </b><br>
                            प्राविधिकको नाम: <?= $result->technician_name ?> <br>
                            प्राविधिकको हस्ताक्षर: ..................... <br>
                        </div>
                        <div class="mt-3">
                            <div class="row mt-5x">

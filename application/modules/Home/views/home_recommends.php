...
<div class="">
    <div class="row no-gutters">
        ...
        <div class="col-lg-9 col-12">
            ...
            <?php echo form_open(base_url().'home-recommend', array('method'=>'get'));?>
            <div class="row">
                <div class="col-lg-9">
                <div class="input-group " style=" padding-right: 20px;">
                        ...
                        <div class="">
                            <button type="submit" name="submit" class="btn btn-lg btn-info" style="padding:9px 25px !important;">View</button>
                        </div>
                    </div>
                </div>
                <?php echo form_close() ;?>
                <div class="col-lg-3">
                    <div class="dropdown">
                        <button class="btn btn-lg btn-secondary dropdown-toggle search-toggle" type="button" id="dropdownMenuButton"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            महिना अनुसार
                        </button>
                        <div class="dropdown-menu search" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item"
                               href="<?= base_url()?>home-recommend?month=3&submit=">पछिल्लो
                                तीन महिनाको</a>
                            <a class="dropdown-item"
                               href="<?= base_url()?>home-recommend?month=6&submit=">पछिल्लो
                                छ महिनाको</a>
                            <a class="dropdown-item"
                               href="<?= base_url()?>home-recommend?month=12&submit=">पछिल्लो
                                बाह्र महिनाको</a>
...
<form id='id_search_form' method='GET' action='<?= base_url()?>home-recommend' class="form-inline ">
      <div class="input-group ">
        ...
        <div class="mr-sm-2" style="border-right: 1px solid #b3aaaa; padding-right: 30px;">
            <button class="btn ml-lg-2 reset btn-block btn-secondary btn-lg" type="button">Reset</button>
        </div>
       ...
       <div class="dropdown">
            ...
            <ul class="dropdown-menu search" aria-labelledby="dropdownMenuButton">
                ...
                <li class="dropdown-item dropdown-submenu">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>home-recommend?status=1&submit=">नवीनतम डाटा</a></div>
                </li>
                <li class="dropdown-item dropdown-submenu">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>home-recommend?status=2&submit=">दर्ता भएको डाटा</a></div>
                </li>
                <li class="dropdown-item dropdown-submenu">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>home-recommend?status=3&submit=">चलानी भएको डाटा</a></div>
                </li>
                <li class="dropdown-item dropdown-submenu" id="search_all">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>home-recommend?status=0&submit=">सम्पूर्ण डाटा </a></div>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12 text-right">
                            ...
                            <a href="<?= base_url()?>home-recommend/create" class="btn font-16 btn-lg btn-success">
                            ...
                            else
                            {
                                ...
                                foreach($result as $data)
                                {
                                    switch($data->status)
                                    {
                                        case 1:
                                            $status = "नभएको";
                                            $html   = '<a href="'.base_url().'home-recommend/edit/'.$data->id.'" class="btn btn-warning">सम्पादन गर्नुहोस</a> |
                                                        <a href="'.base_url().'home-recommend/darta/'.$data->id.'" class="btn btn-success">दर्ता गर्नुहोस</a>';
                                            break;
                                        case 2:
                                            $status ="भएको";
                                            $html   = '<a href="'.base_url().'home-recommend/chalani/'.$data->id.'" class="btn btn-success">चलानी गर्नुहोस</a>';
                                            break;
                                        case 3:
                                            $status ="भएको";
                                    ...
                                    $form_id    = Modules::run("Home/getFormId",$data->id,1);
                        ?>
                        <tr>
                                <td> <?= $i?> </td>
                                <td><a href="home-recommend/detail/<?=$data->id?>"> <?= $data->form_id ?> </a> </td>
                                <td> <?= $data->applicant_name ?> </td>
                                <td> <?= $data->map_sheet_no ?> </td>
                                <td> <?= $data->kitta_no ?> </td>

<?php
    ...
    if(!empty($result->document))
    {
        ...
        $doc_types      = explode("+",$result->document_type);
    }
    // $this_patra_item = Modules::run('Settings/getPatraItem', $this->uri->segment(1));
...
<section class="content ">
        ...
        <li class="breadcrumb-item"><a href="<?= base_url()?>home-road-certify">घर बाटो प्रमाणित</a></li>
                            ...
                            <div class="offset-lg-3 col-lg-6">
                                <table class="table table-borderless my-4">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span id="myInput"><?= $form_id ?></span></td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                ...
                                                {
                                            ?>
                                                <strong class="text-danger">नभएको</strong>
                                            <?php
                                                }
                                                else
                                                {
                                            ?>
                                                <strong class="text-success">भएको</strong>
                                            <?php
                                                }
                                            ?>
                                        </td>
                        ...
                        <div class="table-responsive text-center">
                            <table class="table table-bordered table-sm">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2">घर</td>
                                    <td rowspan="2"> घरको प्रकार</td>
                                    <td rowspan="2">अनुमानित मुल्य</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                ...
                                                if(empty($result->document) && empty($result->darta_documents))
                                                {
                                                        echo "नभएको";
                                                }
                                        ...
                                        <td colspan="2">
                                           <div class="row">
                                                ...
                                                ?>
                                                        <div class="col-lg-6">
                                                            <a class="btn btn-warning btn-submit mt-3 btn-block  "
                                                               href="<?= base_url() ?>home-road-certify/edit/<?= $result->id ?>/">सम्पादन
                                                                गर्नुहोस्</a>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <a class="btn btn-success btn-submit  mt-3 btn-block  "
                                                               href="<?= base_url() ?>home-road-certify/darta/<?= $result->id ?>/">
                                                                दर्ता गर्नुहोस</a>
                                                        </div>
                                                <?php
                                                    }
                                                ...
                                                ?>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <a class="btn btn-success btn-submit mt-3 btn-block  "
                                                               href="<?= base_url() ?>home-road-certify/chalani/<?= $result->id ?>/">
                                                                चलानी गर्नुहोस</a>
                                                        </div>
                                                <?php
                                                    }
                        ...
                        <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab"
                            ...
                            <div class="text-right">
                                <?php if($result->status == 3 ): ?>
                                    <?php echo form_open(base_url().'home-road-certify/print/'.$result->id ,'target="_blank"'); ?>
                            ...
                            <div class="font-14 text-black">
                               ...
                               <div class="letter-head"><!-- Letter head -->
                                <div class="row">
                                    <div class="col-2 letter-head-left">
                                    ...
                                    <div class="col-8 letter-head-center red">
                                        <h2><?= SITE_OFFICE ?></h2>
                                        <div>
                                            <?php if($this->session->userdata('is_muncipality') == 1):?>
                                            <h3> <?= SITE_PALIKA ?> (<?php if(!empty($department)){ echo $department->name;}?>)</h3>
                                            <?php else: ?>
                                    ...
                                    <div class="col-2 text-right letter-head-right">
                               ...
                               <p class="text-body">
                                   ...
                                   वडा नं <b><?= getonlyNumber($old_new_address->new_name)?>
                                   </b> मा पर्ने निम्न कित्ता जग्गाको हालको मितिसम्ममा निम्न अनुसारको  घरबाटो रहेकोले सोही व्यहोरा खुलाई सिफारिस पाउँ भनी <b>
                                       <?php echo SITE_DISTRICT?></b> जिल्ला <b><?php echo SITE_OFFICE ?></b> वडा नं. <b><?= getonlyNumber($old_new_address->new_name)?>
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="2">घर</th>
                                        <th rowspan="2">घरको प्रकार</th>
                                        <th rowspan="2">अनुमानित मुल्य</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= $i ?></td>
                                            <td><?= getonlyNumber($old_new_address->new_name)?></td>
                                            <td><?= $details->map_sheet_no ?></td>
                                            <td><?= $details->kitta_no ?></td>
                                            <td><?= $details->biggha."-".$details->kattha."-".$details->dhur.'-'.$details->paisa?></td>
                                            <td>
                                                <?= $home ?>
                                            </td>
                                            <td>
                                ...
                                <div class="row">
                                    ...
                                    <?php if(!empty($department)){?>
                                     <input type="text" name="post" id="ward_post" class="form-control" style="margin-top:15px;" value="<?php echo  $department->name;?>">
                                    <?php } else { ?>

<?php
    ...
    {
    $action_page = "bato-kayam/create";
    $name = "नयाँ";
    }
    if($this->uri->segment(2)=="edit")
    {
    $action_page = "bato-kayam/edit/".($this->uri->segment(3));
    $name = "साच्याउनुहोस";
    }
...
<section class="content ">
        ...
        <li class="breadcrumb-item"><a href="<?=  base_url()?>bato-kayam">बाटो कायम  </a></li>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select name="gender_spec" class="form-control" id="gender_spec" style="margin-left: 165px" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        जग्गाधनीको नाम<span class="text-danger">&nbsp;*</span>
                                        </span>
                                    </label>
                                            <div class="col-sm-8">
                        ...
                        <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="kitta_no" maxlength="32" class="form-control" required id="id_kitta_no" value="<?= isset($result) ? $result->kitta_no : ''?>"/>
                                        </div>
                                </div>
                        </div>
                        <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="cit_no" maxlength="32" class="form-control" required id="cit_no" value="<?= isset($result) ? $result->cit_no : ''?>"/>
                                        </div>
                                </div>
                        </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="old_place" maxlength="128" value="<?= isset($result) ? $result->old_place : ''?>" class="form-control" required id="id_old_place" />
                                        </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        <span class="float-right">
                                        बाटो खोल्न चाहेको दिशा<span class="text-danger">&nbsp;*</span>
                                        </span>
                                    </label>
                                        <div class="col-sm-8">
                                            <select name="direction" class="form-control" id="id_direction">
                                                   <option value="" selected>दिशा</option>
                                                   <option value="East"  <?php if(isset($result->direction)&&$result->direction == "East")
                                                {
                                                    echo "selected='selected'";
                                                }
                                                ?> >पूर्व</option>

                                                    <option value="West" <?php if(isset($result->direction)&&$result->direction == "West")
                                                {
                                                    echo "selected='selected'";
                                                }
                                                ?> >पश्चिम</option>

                                                    <option value="North" <?php if(isset($result->direction)&&$result->direction == "North")
                                                {
                                                    echo "selected='selected'";
                                                }
                                                ?> >उत्तर</option>

                                                    <option value="South" <?php if(isset($result->direction)&&$result->direction == "South")
                                                {
                                                    echo "selected='selected'";
                                                }
                                                ?> >दक्षिण</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                सडक लम्बाई<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="number" name="road_length" value="<?= isset($result) ? $result->road_length : 0?>" class="form-control" required min="0" id="id_road_length" />
                                                <div class="input-group-append ">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                सडक चौडाई<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="number" name="road_width" value="<?= isset($result) ? $result->road_width : 0?>" class="form-control" required min="0" id="id_road_width" />
                                                <div class="input-group-append ">
                                                    <span class="input-group-text" id="basic-addon2">feet</span>
                                                </div>
                                            </div>

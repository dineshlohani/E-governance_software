                            ...
                            <label class="col-sm-4 col-form-label"><span
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" name="nepali_date" value="<?= isset($result) ? $result->nepali_date : DateEngToNep(date('Y-m-d'))?>" maxlength="10" class="form-control" required id="nepaliDate5" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="land_owner_name" value="<?= isset($result) ? $result->land_owner_name : ''?>" maxlength="128" class="form-control" required id="id_land_owner_name" />
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="cit_no" maxlength="32" class="form-control" id="cit_no" value="<?= isset($result) ? $result->cit_no : ''?>"/>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="con_no" maxlength="10" class="form-control" id="con_no" value="<?= isset($result) ? $result->con_no : ''?>"/>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                        <div class="col-sm-8">
                                            <input type="text" name="mohi_name" value="<?= isset($result) ? $result->mohi_name : ''?>" maxlength="128" class="form-control" required id="id_mohi_name" />
                                        </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="cit_no_1" maxlength="32" class="form-control" id="cit_no_1" value="<?= isset($result) ? $result->cit_no_1 : ''?>"/>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="con_no_1" maxlength="10" class="form-control" id="con_no_1" value="<?= isset($result) ? $result->con_no_1 : ''?>"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="map_sheet_no" value="<?= isset($result) ? $result->map_sheet_no : ''?>" maxlength="32" class="form-control" required id="id_map_sheet_no" />
                                        </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="nepali_visit_date" value="<?= isset($result) ? $result->nepali_visit_date : ''?>" maxlength="10" class="form-control" required id="nepaliDate4" />
                                                <div class="input-group-append">

    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item"><a href="<?=base_url()?>mohi-lagat-katta">मोही लागत कट्टा</a>
                </li>
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade active show font-kalimati" id="details" role="tabpanel" aria-labelledby="nav-home-tab" aria-expanded="true">
                            ...
                            <table class="table table-bordered my-4">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <?=$result->gender_spec?> <?=$result->land_owner_name?></td>
                                    </tr>
                                    <tr>
                                        <td>नागरिकता नं </td>
                                        <td><?=$result->cit_no?></td>
                                    ...
                                    <tr>
                                        <td>मोहीको नाम</td>
                                        <td>
                                            <?=$result->gender_spec_1?> <?=$result->mohi_name?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>नागरिकता नं </td>
                                    ...
                                    <tr>
                                        <td>सर्जमिन मिति</td>
                                        <td><?=$result->nepali_visit_date ?></td>
                                    </tr>
                    ...
                    <div class="row">
                        ...
                        if($result->status == 1) {
                            ?>
                            <div class="col-lg-6">
                                <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>mohi-lagat-katta/edit/<?= $result->id ?>/">सम्पादन
                                गर्नुहोस्</a>
                            </div>
                            <div class="col-lg-6">
                                <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>mohi-lagat-katta/darta/<?= $result->id ?>/">
                                दर्ता गर्नुहोस</a>
                            </div>
                            <?php
                        }
                        elseif ($result->status == 2) {
                            ...
                            <div class="col-lg-6">
                                <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>mohi-lagat-katta/chalani/<?= $result->id ?>/">
                                चलानी गर्नुहोस</a>
                            </div>
                            <?php
                        }
                ...
                <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                    <div class="text-right">
                        ...
                        <?php echo form_open(base_url().'mohi-lagat-katta/print/'.$result->id ,'target="_blank"'); ?>
                    ...
                    <div class="letter">
                        ...
                        <div class="text-justify">
                            उपरोक्त सम्बन्धमा मेरो नाममा दर्ता श्रेष्ता भएको <?= $local_body->name.", वार्ड-".$ward->name?>
                            ...
                            मञ्जुरी
                            सनाखतको आधारमा त्यस
                            कार्यालयको नियमानुसार मोही लागत कट्टा गरिदिनुहुन सिफारिस गरिन्छ ।
                        </div>
                        <div class="mt-5 pt-5">
                            <div class="row">

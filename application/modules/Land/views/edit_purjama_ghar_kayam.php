            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="con_no" value="<?= isset($result) ? $result->con_no : ''?>" maxlength="128"
                      class="form-control" required id="id_applicant_name" />
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input type="checkbox" name="samyukta" id="id_samyukta" value="1"
                      <?php if(isset($result) && ($result->samyukta==1)){ echo 'checked="checked"';}?> />
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="cit_no" value="<?= isset($result) ? $result->cit_no : ''?>" maxlength="128"
                      class="form-control" required id="id_applicant_name" />
                  </div>
                </div>
              </div>

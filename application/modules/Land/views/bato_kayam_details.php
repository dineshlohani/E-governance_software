    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item"><a href="<?=base_url()?>bato-kayam">बाटो कायम </a>
                </li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div>
                                                ...
                                                <a href="<?=  base_url()?>assets/documents/land/bato/<?=$doc?>" target="_blank"><?=$doc?></a>
                                                <?php } ?>
                                            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4" class="text-center" align="center">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <a class="btn btn-warning  btn-submit btn-secondary mt-3" href="<?=  base_url()?>bato-kayam/edit/<?=$result->id?>">
                                                        सम्पादन
                                                        गर्नुहोस्
                                                    </a>
                                                    <a class="btn btn-info  btn-submit btn-secondary mt-3" href="<?=  base_url()?>bato-kayam/darta/<?=$result->id?>">
                                                        दर्ता गर्नुहोस
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <td colspan="4" class="text-center" align="center">
                                            <div class="row">
                                                <div class="col-lg-6 offset-lg-6">
                                                    ...
                                                    <a class="btn btn-info  btn-submit btn-secondary mt-3" href="<?=  base_url()?>bato-kayam/chalani/<?=$result->id?>">
                                                        चलानी गर्नुहोस
                                                    </a>
                                                </div>
                ...
                <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                    ...
                    <div class="text-right">
                        <?php if($result->status == 3  ) : ?>
                            <?php echo form_open(base_url().'bato-kayam/print/'.$result->id ,'target="_blank"'); ?>
                    ...
                    <div class="letter">
                        ...
                        <div class="text-justify">
                            उपरोक्त सम्बन्धमा मेरो नाममा दर्ता श्रेष्ता भएको <b><?= $local_body->name.", वडा-".$ward->name?></b>(साबिकको
                            ...
                            <?=$result->gender_spec?> <b><?=$result->land_owner_name?></b>ले यस
                            वडा कार्यालयमा

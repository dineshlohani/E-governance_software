    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item"><a href="<?=base_url()?>purjama-ghar-kayam">बाटो कायम </a>
                </li>
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade active show font-kalimati" id="details" role="tabpanel" aria-labelledby="nav-home-tab" aria-expanded="true">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div>
                                                ...
                                                <a href="<?=  base_url()?>assets/documents/land/ghar/<?=$doc?>" target="_blank"><?=$doc?></a>
                                                <?php } ?>
                                            </div>
                    ...
                    <div class="row">
                        ...
                        if($result->status == 1) {
                            ?>
                            <div class="col-lg-6">
                                <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>purjama-ghar-kayam/edit/<?= $result->id ?>/">सम्पादन
                                गर्नुहोस्</a>
                            </div>
                            <div class="col-lg-6">
                                <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>purjama-ghar-kayam/darta/<?= $result->id ?>/">
                                दर्ता गर्नुहोस</a>
                            </div>
                            <?php
                        }
                        elseif ($result->status == 2) {
                            ...
                            <div class="col-lg-6">
                                <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>purjama-ghar-kayam/chalani/<?= $result->id ?>/">
                                चलानी गर्नुहोस</a>
                            </div>
                            <?php
                        }
                ...
                <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                    ...
                    <div class="text-right">
                        <?php //if($result->stauts == 3 ) : ?>
                            <?php echo form_open(base_url().'purjama-ghar-kayam/print/'.$result->id ,'target="_blank"'); ?>
                    ...
                    <div class="letter">
                        ...
                        <div class="text-justify">
                            उपरोक्त सम्बन्धमा मेरो नाममा एकलौटी दर्ता श्रेष्ता भएको 
                            <?= $local_body->name.", वडा-".$ward->name?>( साबिकको
                            ठेगाना <?=$result->old_place ?>)
                            कि.नं. <?=$result->kitta_no?> क्षे.फ. <?=$result->biggha."-".$result->kattha."-".$result->dhur?><?= ($result->land_type=="hill") ? "-".$result->paisa : '' ?>
                            जग्गाको
                            जग्गाधनी
                            श्रेष्ता पुर्जामा
                            जग्गा मात्र भएको तर फिल्डमा घर भएकोले जग्गाधनी श्रेष्ता पुर्जामा घर कायम गर्न
                            सिफारिस
                            गरी
                            पाउँ भनि
                            घरजग्गाधनी 
                            <?=$result->gender_spec?> <?=$result->applicant_name?> ले यस वडा कार्यालयमा निवेदन
                            दिनुभएको हुँदा सो
                            सम्बन्धमा त्यहाँको नियमानुसार जग्गाधनी प्रमाण पुर्जामा घर कायम गरिदिनुहुन सिफारिस
                            गरिन्छ
                            ।
                        </div>

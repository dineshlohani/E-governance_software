<?php
    ...
    {
    $action_page = "mohi-lagat-katta/create";
    $name = "नयाँ";
    }
    if($this->uri->segment(2)=="edit")
    {
    $action_page = "mohi-lagat-katta/edit/".($this->uri->segment(3));
    $name = "साच्याउनुहोस";
    }
  ...
  <div class="container-fluid ">
    <nav aria-label="breadcrumb" class="bg-shadow">
      <ol class="breadcrumb px-3 py-2">
        ...
        <li class="breadcrumb-item"><a href="<?=  base_url()?>mohi-lagat-katta">मोही लागत कट्टा </a></li>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <div class="input-group">
                  <input type="text" name="nepali_date"
                    value="<?= isset($result) ? $result->nepali_date : DateEngToNep(date('Y-m-d'))?>" maxlength="10"
          ...
          <div class="col-md-12">
            <div class="row">
                ...
                <div class="form-group row">
                  <label class="col-md-4 col-form-label">
                    <span class="float-right">
                      जग्गाधनीको नाम<span class="text-danger">&nbsp;*
                      </span>
                    </span>
                  </label>
                  <label class="col-md-4 col-form-label">
              ...
              <div class="col-md-6">
                ...
                <div class="col-sm-8">
                  <input type="text" name="land_owner_name" value="<?= isset($result) ? $result->land_owner_name : ''?>"
                    maxlength="128" class="form-control" required id="id_land_owner_name" />
                </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-md-4 col-form-label">
                    <span class="float-right">
                      नागरिकता प्र.नं.<span class="text-danger">&nbsp;*</span>
                    </span>

                  </label>

                  <div class="col-sm-8">
                    <input type="text" name="cit_no" maxlength="32" class="form-control" id="cit_no"
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group">
                      <input type="text" name="con_no" maxlength="10" class="form-control" id="con_no"
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-md-4 col-form-label">
                    <span class="float-right">
                      मोहीको नाम<span class="text-danger">&nbsp;*
                      </span>
                    </span>
                  </label>
                  <label class="col-md-4 col-form-label">
                    <select name="gender_spec_1" class="form-control" id="gender_spec_1" required>
                      <option selected>---Select---</option>
                      <option value="श्री">श्री</option>
                      <option value="सुश्री">सुश्री</option>
                      <option value="श्रीमती">श्रीमती</option>
              ...
              <div class="col-md-6">
                <div class="col-sm-8">
                  <input type="text" name="mohi_name" value="<?= isset($result) ? $result->mohi_name : ''?>"
                    maxlength="128" class="form-control" required id="id_mohi_name" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="cit_no_1" maxlength="32" class="form-control" id="cit_no_1"
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group">
                      <input type="text" name="con_no_1" maxlength="10" class="form-control" id="con_no_1"
                        value="<?= isset($result) ? $result->con_no_1 : ''?>" />
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="kitta_no" value="<?= isset($result) ? $result->kitta_no : ''?>"
                      maxlength="32" class="form-control" required id="id_kitta_no" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="map_sheet_no" value="<?= isset($result) ? $result->map_sheet_no : ''?>"
                      maxlength="32" class="form-control" required id="id_map_sheet_no" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-3 mb-sm-2">
                <select name="district" class="form-control select2 district_selected" id="district_selected-1"
                  ...
                  <?php
                                    ...
                                    ?>
                  <option value="<?= $district->id ?>" <?php if($result->district == $district->id)
                                                {
                                                    echo "selected='selected'";
                                                }
              ...
              <div class="col-md-3 mb-sm-2">
                <select name="local_body" class="form-control select2 local_body_selected" id="local_body_selected-1"
                  ...
                  <?php
                                        ...
                                        {
                                    ?>
                  <option value="<?= $local->id ?>" <?php if($result->local_body == $local->id)
                                                {
                                                    echo "selected='selected'";
                                                }
                                                ?>><?= $local->name ?></option>
              ...
              <div class="col-md-2 mb-sm-2">
                <select name="ward" class="form-control select2 ward_selected" id="ward_selected-1" required>
                  ...
                  <?php
                                    ...
                                    ?>
                  <option value="<?= $ward->id ?>" <?php if($result->ward == $ward->id)
                                                {
                                                    echo "selected='selected'";
                                                }
                                                ?>><?= $ward->name ?></option>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="old_place" value="<?= isset($result) ? $result->old_place : ''?>"
                      maxlength="128" class="form-control" required id="id_old_place" />
                  </div>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-md-4 col-form-label">
                    <span class="float-right">
                      सर्जमिन मिति<span class="text-danger">&nbsp;*</span>
                    </span>
                  ...
                  <div class="col-sm-8">
                    <div class="input-group">
                      <input type="text" name="nepali_visit_date"
                        value="<?= isset($result) ? $result->nepali_visit_date : ''?>" maxlength="10"
                        class="form-control" required id="nepaliDate4" />
                      <div class="input-group-append">

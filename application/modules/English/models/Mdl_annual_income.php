...
class Mdl_annual_income extends CI_Model
{
    /*------------------------------------------------------------------------------------------------------------------*/
...
//        $this->db->where('type="fox" OR type="dog"');
    ...
    public function getTableName()
    {
      ...
      public function saverels($post_data) {
        ...
        $this->db->insert_batch('income_details_en',$post_data);
    ...
    public function getRelationShipDetails($id){
        $query = $this->db->get_where('income_details_en', array('main_id' => $id));
    ...
    public function updateMembers($id, $post_array) {
        $this->db->trans_start();;
        $this->db->update_batch('income_details_en',$post_array,'id');
        $this->db->trans_complete();
    ...
    {
        if ($query = $this->db->delete('income_details_en', array('id' => $id))) {
            return true;
        } else {
            return false;
        }

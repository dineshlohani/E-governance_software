                ...
                <tbody>
                  ...
                  <tr class="text-center font-bold font-20">
                    ...
                    <td colspan="2"><i class="fa fa-check-circle-o"
                        style="color:<?php echo $detail->status == 1 ? "red": $detail->status == 2 ? "blue":$result->status == 3 ? 'green':'red';?>"></i>
                      Unmarried Verification</td>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              ...
                              <a class="btn btn-warning btn-submit mt-3 btn-block  "
                                href="<?= base_url() ?>unmarried-en/edit/<?= $result->id ?>/">सम्पादन गर्नुहोस्</a>
                            ...
                            <div class="col-lg-6">
                              ...
                              <a class="btn btn-success btn-submit  mt-3 btn-block  "
                                href="<?= base_url() ?>unmarried-en/darta/<?= $result->id ?>/">दर्ता गर्नुहोस</a>
                            ...
                            <div class="col-lg-6">
                              ...
                              <a class="btn btn-success btn-submit mt-3 btn-block  "
                                href="<?= base_url() ?>unmarried-en/chalani/<?= $result->id ?>/">चलानी गर्नुहोस</a>
              ...
              <div class="font-14 text-black" style="line-height: 1.6;">
                ...
                <div class="letter">
                  ...
                  <div class="text-justify" style=" font-family: Arial; ">
                    ...
                    This is to certify that <b><?php echo ($result->gender==1)?'Mr':'Mrs';?>
                      <?php echo $result->app_name?></b> and <?php echo ($result->gender==1)?'Son':'Daughter';?> of
                    <b>Mr. <?php echo $result->father_name?></b> and <b> MRs. <?php echo $result->mother_name?></b>
                    having citizenship No. <b><?php echo $result->ctn_no?> </b> permanent resident of
                    <?php echo $per_gapa->english_name?> ward
                    ...
                    no.<?php echo $result->former_ward?>) has submitted an application letter for maritial status
                    certificate at <?php echo SITE_OFFICE_ENG?> and according to witness at ward level
                    <?php echo $genderspec?> has been
                    found to be single in maritial stauts till <?php echo $chalani_details->english_chalani_miti?>.

...
{
  $action_page = "name-verification-en/update";
  $name = "नवीनतम डाटा";
}
if($this->uri->segment(2)=="edit")
{
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group row">
                  <label class="col-md-2 col-form-label">
                    <span class="float-right">
                      Grandfather's Name<span class="text-danger">&nbsp;*</span>
                    </span>
                  </label>
                  <div class="col-sm-8">
                    <input type="text" name="mother_name" placeholder=""  class="form-control" required="required"value="<?php echo $detail->grand_father_name?>">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="written_name" placeholder=""  class="form-control" required="required"value="<?php echo $detail->diff_name?>">
                  </div>
                </div>
              </div>
            </div>

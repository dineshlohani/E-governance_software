              ...
              <table class="table table-bordered my-4">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $result->grand_father_name ?></td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      Name in Academics Details

                    </td>

                    <td><?= $result->diff_name ?></td>
                  ...
                  <!--   <tr>
                              ...
                              <td class="numbers">
                                 ...
                                 <?= $per_gapa->english_name.", ward no-".$result->per_ward.", ".$per_district->name .",".$per_state->english_name.", Nepal"?>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              ...
                              <a class="btn btn-warning btn-submit mt-3 btn-block  "
                                href="<?= base_url() ?>name-verification-en/edit/<?= $result->id ?>/">सम्पादन
                                गर्नुहोस्</a>
                            ...
                            <div class="col-lg-6">
                              ...
                              <a class="btn btn-success btn-submit  mt-3 btn-block  "
                                href="<?= base_url() ?>name-verification-en/darta/<?= $result->id ?>/">दर्ता
                                गर्नुहोस</a>
                            ...
                            <div class="col-lg-6">
                              ...
                              <a class="btn btn-success btn-submit mt-3 btn-block  "
                                href="<?= base_url() ?>name-verification-en/chalani/<?= $result->id ?>/">चलानी
                                गर्नुहोस</a>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="text-right">
                ...
                <?php echo form_open(base_url().'name-verification-en/print/'.$result->id ,'target="_blank"'); ?>
              ...
              <div class="font-14 text-black" style="line-height: 1.6;">
                ...
                <div class="letter">
                  ...
                  <div class="text-justify" style=" font-family: Arial; ">
                    ...
                    This is to inform and certify to the concern authority regarding the name of applicant (Grand
                    <?php echo $son ?> of
                    <b><?php echo $result->grand_father_name?></b> and Son of <b><?php echo $result->father_name?>)</b>
                    is different in academic transcripts, character certificates and citizenship. The name of student
                    written as <b><?php echo $result->diff_name?></b> in all academic transcripts and certificates but
                    <?php echo $his?> name written as <b><?php echo $result->app_name?></b> in cetizenship issued by
                    Government of
                    Nepal.
                  ...
                  <div class="text-justify" style=" font-family: Arial; ">
                    ...
                    The above mentioned spelling of <b><?php echo $result->app_name?></b> and
                    <b><?php echo $result->diff_name?></b> are same in use.
                  ...
                  <div class="text-justify" style=" font-family: Arial; ">
                    ...
                    Feel free if you have any inquiry regarding his Name case

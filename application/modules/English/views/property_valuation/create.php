      ...
      <div class="container-fluid ">
        ...
        <nav aria-label="breadcrumb" class="bg-shadow">
          ...
          <ol class="breadcrumb px-3 py-2">
            ...
            <li class="breadcrumb-item"><a href="<?=  base_url()?>property-valuation-en">Annual Income Certificate</a></li>
                ...
                <table class="table table-bordered" id="add_new_fields">
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <th>Plot No <span style="color:red">*</span></th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><textarea name="owner_name[]" class="form-control" style="height:37px;"></textarea></td>

                      <td><input type="text" name="desc[]" class="form-control"></td>

                      <td><textarea name="location[]" class="form-control" style="height:37px;"></textarea></td>

...
{
  $action_page = "property-valuation-en/update";
  $name = "नवीनतम डाटा";
}
if($this->uri->segment(2)=="edit")
{
      ...
      <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
          <ol class="breadcrumb px-3 py-2">
            ...
            <li class="breadcrumb-item"><a href="<?=  base_url()?>property-valuation-en"> Certificate of Proporty Valuation</a></li>
                ...
                <table class="table table-bordered" id="add_new_fields">
                 ...
                 <tbody>
                  ...
                  <tr>
                    ...
                    <td><textarea name="owner_name[]" class="form-control" style="height:37px;"><?php echo $source->owner_name?></textarea></td>
                    <td><input type="text" name="desc[]" class="form-control" value="<?php echo $source->descp?>"></td>
                    <td><input type="text" name="location[]" class="form-control" value="<?php echo $source->location?>"></td>
                    <td><input type="text" name="plot_no[]" class="form-control" value="<?php echo $source->plot_no?>"></td>
                    <td><input type="text" name="area[]" class="form-control" value="<?php echo $source->area?>"></td>
                    <td><input type="text" name="amount[]" class="form-control" value="<?php echo $source->amount?>"></td>
                    <td><a href="<?php echo base_url()?>English/PropertyValuation/removeData/<?php echo $source->main_id?>/<?php echo $source->id?>" class="btn  btn-danger" onclick="return  confirm('के तपाइँ  यसलाई हटाउन निश्चित हुनुहुन्छ ?')"><i class="fa fa-minus" style="color:#FFF"></i></a></td>
                  </tr>
                <?php endforeach;endif;?>
                </tbody>
              </table>

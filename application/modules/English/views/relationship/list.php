    ...
    <div class="container-fluid ">
        ...
        <nav aria-label="breadcrumb" class="bg-shadow">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url()?>relationship">Relationship</a></li>
            ...
            <div class="body">
                ...
                <div class="row">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-9 col-12">
                                    ...
                                    <div class="date-content d-none" >
                                        ...
                                        <?php echo form_open(base_url().'relationship', array('method'=>'get'));?>
                                    ...
                                    <div class="search-form" >
                                        ...
                                        <div class="col-12 col-lg-10 mb-2 mr-sm-2">
                                            ...
                                            <form id='id_search_form' method='GET' action='<?= base_url()?>relationship' class="form-inline ">
                    ...
                    <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12 text-right">
                        ...
                        <a href="<?= base_url()?>relationship/create"  class="btn font-16 btn-lg btn-success">
                        ...
                        foreach($result as $data)
                        {
                            switch($data->status)
                            {
                                case 1:
                                    ...
                                    $html   = '<a href="'.base_url().'relationship/edit/'.$data->id.'" class="btn btn-warning">Edit</a> |

                                                        <a href="'.base_url().'relationship/darta/'.$data->id.'" class="btn btn-success">Darta</a>';
                                    break;
                                case 2:
                                    $status ="Yes";
                                    $html   = '<a href="'.base_url().'relationship/chalani/'.$data->id.'" class="btn btn-success">Chalani</a>';
                                    break;
                                case 3:
                                    $status ="Yes";
                            ...
                            <tr>
                                ...
                                <td><a href="<?= base_url()?>relationship/detail/<?=$data->id?>"> <?= $data->form_id; ?> </a> </td>

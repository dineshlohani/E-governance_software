      ...
      <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
          <ol class="breadcrumb px-3 py-2">
            ...
            <li class="breadcrumb-item"><a href="<?=  base_url()?>married-en"> Name Verification</a></li>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-4 col-form-label"><span
                    class="">Married Date(BS)<span
                    class="text-danger">&nbsp;*</span></span></label>
                    <div class="col-sm-8">
                      <div class="input-group">
                        <input type="text" name="married_date_bs" value="<?=isset($detail)?$detail->married_date_bs:''?>" maxlength="10" class="form-control nep_dob" required id="nepaliDate4" />
                ...
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="married_date_ad" readonly="true" value="<?=isset($detail)?$detail->married_date_ad:''?>" class="form-control" required id="id_eng_dob" />
                    </div>
                  </div>
                </div>
              </div>
           ...
           <div class="row">
            <div class="col-md-12">
              <div class="form-group row">
               ...
               <div class="col-sm-8">
                <input type="text" name="wife_name" placeholder=""  class="form-control" required="required" value="<?php echo $detail->wife_name?>">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" name="wife_father_name" placeholder=""  class="form-control" required="required" value="<?php echo $detail->wife_father_name?>">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" name="wife_mother_name" placeholder=""  class="form-control" required="required" value="<?php echo $detail->wife_mother_name?>">
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="form-group row">
              <label class="col-sm-4 col-form-label"><span
                ...
                <div class="col-sm-8">
                  <select name="wife_per_state" class="form-control select2 state_selected_en" id="state_selected_en-2">
                    ...
                    <?php if(!empty($states)) : 
                      foreach ($states as $key => $state) :?>
                        <option value="<?php echo $state->id?>" <?php if($state->id == $detail->wife_state){echo 'selected';}?>><?php echo $state->english_name?></option>
                      <?php endforeach; endif;?>
                    </select>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <select name="wife_per_dis" class="form-control select2 district_selected_en" id="selected_district_en-2" required="required">
                      <option value="">--select</option>
                      <?php if(!empty($districts)) :
                        foreach($districts as $key => $district) :?>
                          <option value="<?php echo $district->id?>" <?php if($district->id == $detail->wife_district){echo 'selected';}?>><?php echo $district->english_name?></option>
                        <?php endforeach;endif;?>
                      </select>
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label"><span
                      class="">Gapa/Napa<span
                      class="text-danger">&nbsp;*</span></span></label>
                      <div class="col-sm-8">
                        <select name="wife_per_gapanapa" class="form-control select2 select_local_body" id="local_body_selected_en-2" required >
                          <option value="">--select--</option>
                          <?php if(!empty($locals)) :
                            foreach($locals as $key => $l) :?>
                              <option value="<?php echo $l->id?>" <?php if($l->id == $detail->wife_ganapa){echo 'selected';}?>><?php echo  $l->english_name?></option>
                            <?php endforeach;endif;?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select name="wife_per_ward" class="form-control select2" id="selected_ward-2">
                            ...
                            <?php if(!empty($wards)) :
                              foreach($wards as $key => $w) :?>
                                <option value="<?php echo $w->name?>" <?php if($w->id == $detail->wife_ward){echo 'selected';}?>><?php echo  $w->name?></option>
                              <?php endforeach;endif;?>
                            </select>
                          </div>
                        </div>

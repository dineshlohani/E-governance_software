...
<?php
    ...
    $genderspec = ($result->gender == 1) ? 'he' : 'her';
              ...
              <table class="table table-bordered my-4">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="numbers"> <?= $result->married_date_bs ?>(BS)/<?= $result->married_date_ad?>(AD)</td>
                  ...
                  <tr>
                    ...
                    <td class="numbers">
                      ...
                      <?= $wife_gapa->english_name.", ward no-".$result->wife_ward.", ".$wife_district->english_name .",".$wife_state->english_name.", Nepal"?>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              ...
                              <a class="btn btn-warning btn-submit mt-3 btn-block  "
                                href="<?= base_url() ?>married-en/edit/<?= $result->id ?>/">सम्पादन गर्नुहोस्</a>
                            ...
                            <div class="col-lg-6">
                              ...
                              <a class="btn btn-success btn-submit  mt-3 btn-block  "
                                href="<?= base_url() ?>married-en/darta/<?= $result->id ?>/">दर्ता गर्नुहोस</a>
                            ...
                            <div class="col-lg-6">
                              ...
                              <a class="btn btn-success btn-submit mt-3 btn-block  "
                                href="<?= base_url() ?>married-en/chalani/<?= $result->id ?>/">चलानी गर्नुहोस</a>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="text-right">
                ...
                <?php echo form_open(base_url().'married-en/print/'.$result->id ,'target="_blank"'); ?>
              ...
              <div class="font-14 text-black" style="line-height: 1.6;">
                ...
                <div class="letter">
                  ...
                  <div class="text-justify" style=" font-family: Arial; ">
                    ...
                    This is to certify that <b><?php echo 'Mr'?> <?php echo $result->app_name?></b> and Son of <b>Mr.
                      <?php echo $result->father_name?></b> and <b> MRs. <?php echo $result->mother_name?></b> permanent
                    inhabitance of <?php echo $per_gapa->english_name?> ward
                    ...
                    <?php echo $result->wife_father_name?> and Mrs. <?php echo $result->wife_mother_name?> an
                    inhabitance of <?php echo $wife_gapa->english_name?> ward no <?php echo $result->wife_ward?>,
                    <?php echo $wife_district->english_name?>, <?php echo $wife_state->english_name?> got married on
                    <?php echo $result->married_date_bs?>(BS)/ <?php echo $result->married_date_ad?>(AD) according to
                    our office record.

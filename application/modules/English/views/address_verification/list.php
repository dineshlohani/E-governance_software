            ...
            <div class="body">
                <div class="row">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-9 col-12">
                                    <div class="date-content d-none" >
                                        <?php echo form_open(base_url().'address-verification-en', array('method'=>'get'));?>
                                        <div class="row">
                                            <div class="col-lg-9">
                                                ...
                                                <div class="dropdown mr-sm-2">
                                                    ...
                                                    <div class="dropdown-menu search" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item"
                                                           href="<?= base_url()?>address-verification-en?month=3&submit=">पछिल्लो
                                                            तीन महिनाको</a>
                                                        <a class="dropdown-item"
                                                           href="<?= base_url()?>address-verification-en?month=6&submit=">पछिल्लो
                                                            छ महिनाको</a>
                                                        <a class="dropdown-item"
                                                           href="<?= base_url()?>address-verification-en?month=12&submit=">पछिल्लो
                                                            बाह्र महिनाको</a>
                                    ...
                                    <div class="search-form" >
                                        <div class="col-12 col-lg-10 mb-2 mr-sm-2">
                                            ...
                                            <form id='id_search_form' method='GET' action='<?= base_url()?>address-verification-en' class="form-inline ">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu search" aria-labelledby="dropdownMenuButton">
                                                                ...
                                                                <li class="dropdown-item dropdown-submenu">
                                                                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>address-verification-en?status=1&submit=">नवीनतम डाटा</a></div>
                                                                </li>
                                                                <li class="dropdown-item dropdown-submenu">
                                                                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>address-verification-en?status=2&submit=">दर्ता भएको डाटा</a></div>
                                                                </li>
                                                                <li class="dropdown-item dropdown-submenu">
                                                                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>address-verification-en?status=3&submit=">चलानी भएको डाटा</a></div>
                                                                </li>
                                                                <li class="dropdown-item dropdown-submenu" id="search_all">
                                                                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>address-verification-en?status=0&submit=">सम्पूर्ण डाटा </a></div>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    <?php endif; ?>
                    ...
                    <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12 text-right">
                        ...
                        <a href="<?= base_url()?>address-verification-en/create"  class="btn font-16 btn-lg btn-success">
                ...
                <table class="table table-responsive-sm table-responsive-md table-bordered"  style="width:100%;">
                    ...
                    else
                    {
                        ...
                        foreach($result as $data)
                        {
                            ...
                            {
                                case 1:
                                    $status = "not dispached";
                                    $html   = '<a href="'.base_url().'address-verification-en/edit/'.$data->id.'" class="btn btn-warning">सम्पादन गर्नुहोस</a> |
                                                        <a href="'.base_url().'address-verification-en/darta/'.$data->id.'" class="btn btn-success">दर्ता गर्नुहोस</a>';
                                    break;
                                case 2:
                                    $status ="darta";
                                    $html   = '<a href="'.base_url().'address-verification-en/chalani/'.$data->id.'" class="btn btn-success">चलानी गर्नुहोस</a>';
                                    break;
                                case 3:
                                    $status ="chalani";
                            ...
                            <tr>
                                <td> <?= $i?> </td>
                                <td><a href="<?= base_url()?>address-verification-en/detail/<?=$data->id?>"> <?= $data->form_id; ?> </a> </td>

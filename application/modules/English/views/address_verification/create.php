                  ...
                  <div class="form-group row">
                    ...
                    <label class="col-sm-4 col-form-label"><span
                      ...
                      <div class="col-sm-8">
                        ...
                        <select name="per_state" class="form-control state_selected_en" id="state_selected_en-1">
                    ...
                    <div class="form-group row">
                      ...
                      <label class="col-sm-4 col-form-label"><span
                        ...
                        <div class="col-sm-8">
                         ...
                         <input type="text" name="old_name" value="" class="form-control">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      ...
                      <input type="number" name="old_ward" class="form-control">

                      <!-- <select name="old_ward" class="form-control select2" id="selected_ward-1">

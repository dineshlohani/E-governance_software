...
class NameVerification extends MX_Controller {
...

    {
        ...
        $this->load->model('English/Mdl_name_verification');
    ...
    {  
        ...
        $data['title']  = "Name Verification | Dashboard";

        $data['result']  = $this->Mdl_name_verification->getAll();

        $this->load->view('User/header',$data);

        $this->load->view('name_verification/list');
    ...
    { 
        ...
        $data1['title']         = "Name Verification | Create";

        $this->load->view('User/header',$data1);

        $this->load->view('name_verification/create',$data);
    ...
    public function saveDetails() {
        ...
        if(isset($_POST['submit'])) {
           ...
           // $per_gapana             = $this->input->post('per_gapanapa');
            ...
            if($id = $this->Mdl_name_verification->save($save)) {

                $this->session->set_flashdata('msg'," Success");

                redirect('name-verification-en/detail/'.$id);

            } else {

                $this->session->set_flashdata('err_msg'," समस्या आयो |");

                redirect('name-verification-en/create');
    ...
    public function darta_view() {
        ...
        if(empty($id)){
            ...
            redirect('name-verification-en');

        }

        Modules::run("User/checkWardLogin");

        $data['title']                  = "Name Verification | Details";

        $data['page']                   = 'name_verification/details';
        ...
        $data['result']                 = $this->Mdl_name_verification->getById($id);

        $data['sources']                = $this->Mdl_name_verification->getRelationShipDetails($id);
    ...
    public function edit_details() {
        ...
        $data['page']           = 'name_verification/edit';
        ...
        $data['detail']         = $this->Mdl_name_verification->getById($id);
    ...
    public function update() {
         ...
         if(isset($_POST['submit'])) {
            ...
            if($this->Mdl_name_verification->update($id,$save)) {
    ...
    public function darta_details() {
        ...
        $result     = $this->Mdl_name_verification->getById($id);
        ...
        if($this->Mdl_name_verification->update($id,$data))
...

    {
...

        {
            ...
            redirect("name-verification-en/detail/".$result->id);
    ...
    public function print() {
        ...
        $data['result'] = $result   = $this->Mdl_name_verification->getById($id);
       ...
       //  }
        ...
        $this->load->view('name_verification/print',$data);
    ...
    public function removeData($main_id,$id) {
        ...
        $result = $this->Mdl_name_verification->deleteSource($id);

        if($result) {

            $this->session->set_flashdata('msg',"Success | ");

            redirect("name-verification-en/edit/".$main_id);

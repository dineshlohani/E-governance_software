  <form action="<?php echo base_url()?>LandCategory/Save" method="post" class="form save_post">
    ...
    <div class="form-group">
      <div class="col-md-12">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control " placeholder="" name="category" required="required" value="<?php if(!empty($row['id'])){ echo $row['category'];} ?>">
        </div>
      </div>
    </div>

...
if(isset($result))
{
    $action_page = base_url()."add_road_type/".$result->id;
}
else
{
    $action_page = base_url()."add_road_type";
}
    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item active">सडकको प्रकार</li>
        ...
        <div class="card">
            ...
            <div class="box box-primary"  style="margin-left: 10px">
                <div class="box-header with-border">
                    <center><h4 class="box-title">सडकको प्रकारहरु </h4></center>
                </div>
                <table id="table1" class="table table-bordered table-striped">
                    ...
                    foreach ($roads as $road){
                        ...
                        <tr>
                            ...
                            <td><?=$road->name?></td>
                            <td>
                                <a href="<?=base_url()?>add_road_type/<?=$road->id?>">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a>&nbsp;&nbsp;
                                <a href="<?=base_url()?>road_type/<?=$road->id?>">

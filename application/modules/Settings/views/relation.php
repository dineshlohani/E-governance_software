...
if(isset($result))
{
    $action_page = base_url()."add_relation/".$result->id;
}
else
{
    $action_page = base_url()."add_relation";
}
        ...
        <div class="card">
            ...
            <div class="box box-primary"  style="margin-left: 10px">
                <div class="box-header with-border">
                    <center><h4 class="box-title">नाताहरू</h4></center>
                </div>
                <table id="table1" class="table table-bordered table-striped">
                    ...
                    foreach ($relations as $relation){
                        ...
                        <tr>
                            <td><?=$i?></td>
                            <td><?=$relation->name?></td>
                            <td><?= $relation->english_name?></td>
                            <td>
                                <a href="<?=base_url()?>add_relation/<?=$relation->id?>">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a>&nbsp;&nbsp;
                                <a href="<?=base_url()?>relation/<?=$relation->id?>">

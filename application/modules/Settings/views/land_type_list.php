...
<section class="content">
    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item active">विवाहको प्रकार</li>
    ...
    <div class="container-fluid ">
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-12 col-md-6 offset-md-3" >
                    ...
                    <div class="form-group">
                        <label>जग्गाको किसिम/वर्ग</label>
                        <input type="text" name="category" class="form-control " value="<?php if(isset($result->category)){ echo $result->category;}?>" required>
                    </div>
                    <div class="form-group">
            ...
            <?php if(!empty($landtype)){?>
            <div class="box box-primary"  style="margin-left: 10px">
                <div class="box-header with-border">
                    <center><h4 class="box-title">विवाहको प्रकारहरु</h4></center>
                </div>
                <table id="table1" class="table table-bordered table-striped">
                    <thead>
                    <tr>
                        <th>क्र.स.</th>
                        <th>जग्गाको किसिम/वर्ग</th>
                        <th>&nbsp;</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                        $i = 1;
                        foreach ($landtype as $data){
                    ?>
                        <tr>
                            <td><?= $i?></td>
                            <td><?= $data->category ?></td>
                            <td>
                                <a href="<?=base_url()?>edit-land-type/<?=$data->id?>">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a>&nbsp;&nbsp;
                                <a href="<?=base_url()?>delete-land-type/<?=$data->id?>">

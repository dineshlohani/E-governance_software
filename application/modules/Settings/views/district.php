...
if(isset($result))
{
    $action_page = base_url()."add_district/".$result->id;
}
else
{
    $action_page = base_url()."add_district";
}
    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item active">जिल्ला</li>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-12 col-md-6 offset-md-3" >
                    ...
                    <div class="form-group">
                        <label>जिल्लाको नाम(English)</label>
            ...
            <div class="box box-primary"  style="margin-left: 10px">
                <div class="box-header with-border">
                    <center><h4 class="box-title">जिल्लाहरु</h4></center>
                </div>
                <table id="table1" class="table table-bordered table-striped">
                    ...
                    foreach ($districts as $district){
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?=base_url()?>add_district/<?=$district->id?>">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a>&nbsp;&nbsp;
                                <a href="<?=base_url()?>district/<?=$district->id?>">

...
if(isset($result))
{
    $action_page = base_url()."bodartha/".$result->id;
}
else
{
    $action_page = base_url()."bodartha";
}
    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item active">बोद्यार्थ</li>
        ...
        <div class="card">
            ...
            <div class="box box-primary"  style="margin-left: 10px">
                <div class="box-header with-border">
                    <center><h4 class="box-title">पदहरु</h4></center>
                </div>
                <table id="table1" class="table table-bordered table-striped">
                    ...
                    foreach ($posts as $post){
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?=base_url()?>bodartha/<?=$post->id?>">

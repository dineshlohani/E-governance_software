...
if(isset($result))
{
    $action_page = base_url()."add_local/".$result->id;
}
else
{
    $action_page = base_url()."add_local";
}
    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item active">गा.पा./न.पा.</li>
        ...
        <div class="card">
            ...
            <div class="box box-primary"  style="margin-left: 10px">
                <div class="box-header with-border">
                    <center><h4 class="box-title">गा.पा./न.पा. हरु</h4></center>
                </div>
                <table id="table1" class="table table-bordered table-striped">
                    ...
                    foreach ($locals as $local){
                        ...
                        <tr>
                            <td><?=$i?></td>
                            <td><?=$local->name?></td>
                            <td><?= $local->english_name ?></td>
                            <td>
                                <a href="<?=base_url()?>add_local/<?=$local->id?>">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a>&nbsp;&nbsp;
                                <a href="<?=base_url()?>local/<?=$local->id?>">

...
class Mdl_ward_worker extends CI_Model
{
    /*------------------------------------------------------------------------------------------------------------------*/
    private $_tableName = "settings_ward_worker";
    /*------------------------------------------------------------------------------------------------------------------*/
...
//        $this->db->order_by("id", "asc");
    ...
    {
//        $this->db->order_by("id", "asc");
        $query = $this->db->get_where($this->_tableName,array('ward'=> $ward));
    ...
    /*------------------------------------------------------------------------------------------------------------------*/
    public function getByWardPost($ward)
    {
        $query = $this->db->get_where($this->_tableName, array('ward'=> $ward, 'is_signature' => '1'));

...
if(isset($result))
{
    $action_page = base_url()."add_direction/".$result->id;
}
else
{
    $action_page = base_url()."add_direction";
}
    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item active">दिशा</li>
        ...
        <div class="card">
            ...
            <div class="box box-primary"  style="margin-left: 10px">
                <div class="box-header with-border">
                    <center><h4 class="box-title">दिशाहरू</h4></center>
                </div>
                <table id="table1" class="table table-bordered table-striped">
                    ...
                    foreach ($directions as $direction){
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?=base_url()?>add_direction/<?=$direction->id?>">
                                    <img src="<?=base_url()?>assets/images/icons/edit.png">
                                </a>&nbsp;&nbsp;
                                <a href="<?=base_url()?>direction/<?=$direction->id?>">

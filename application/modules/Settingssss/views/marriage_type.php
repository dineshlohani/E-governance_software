...
if(isset($result))
{
    $action_page = base_url()."add-marriage-type/".$result->id;
}
else
{
    $action_page = base_url()."add-marriage-type";
}
        ...
        <div class="card">
            ...
            <div class="box box-primary"  style="margin-left: 10px">
                ...
                <table id="table1" class="table table-bordered table-striped">
                    ...
                    <?php
                        $i = 1;
                        foreach ($marriage_types as $data){
                    ?>
                        <tr>
                            <td><?= $i?></td>
                            <td><?= $data->name ?></td>
                            <td>
                                <a href="<?=base_url()?>add-marriage-type/<?=$data->id?>">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a>&nbsp;&nbsp;
                                <a href="<?=base_url()?>marriage-type/<?=$data->id?>">

<?php
    ...
    {
    $action_page = "kotha-khali-suchana/create"; }
    if($this->uri->segment(2)=="edit")
    {
    $action_page = "kotha-khali-suchana/edit/".$this->uri->segment(3);
    }
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label" style="margin-left:164px">
                                           <select name="gender_spec" class="gender_spec">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="applicant_name" maxlength="256" class="form-control" required id="id_applicant_name"  value="<?= isset($result) ? $result->applicant_name :''?>"/>
                                        </div>
                                </div>
                            </div>
                        </div>

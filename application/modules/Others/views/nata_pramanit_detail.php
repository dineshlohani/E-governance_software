<?php
    ...
    $path           = base_url()."assets/documents/others/nata_pramanit/";
      ...
      <div class="tab-content" id="nav-tabContent">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                          <a class="btn btn-warning btn-submit mt-3 btn-block  "
                            href="<?= base_url() ?>nata-pramanit/edit/<?= $result->id ?>/">सम्पादन
                            गर्नुहोस्</a>
                        </div>
                        <div class="col-lg-6">
                          <a class="btn btn-success btn-submit  mt-3 btn-block  "
                            href="<?= base_url() ?>nata-pramanit/darta/<?= $result->id ?>/">
                            दर्ता गर्नुहोस</a>
                        </div>
                        <?php
                                                    }
                        ...
                        <div class="col-lg-6">
                          <a class="btn btn-success btn-submit mt-3 btn-block  "
                            href="<?= base_url() ?>nata-pramanit/chalani/<?= $result->id ?>/">
                            चलानी गर्नुहोस</a>
                        </div>
                        <?php
                                                    }
        ...
        <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
          <div class="text-right">
            ...
            <?php echo form_open(base_url().'nata-pramanit/print/'.$result->id ,'target="_blank"'); ?>
          ...
          <div class="letter">
            ...
            <div class="text-center font-26" style="margin-bottom: 20px;">
              <h4><span class="red" style="border-bottom: 1px solid black; margin-bottom: 5px;">नाता प्रमाणित
                  प्रमाणपत्र</span>
              </h4>
            </div>
            <div>
            ...
            <div class="text-justify" style="margin-top: 10px; text-indent: 200px;">
              ...
              मिति <?= $result->nepali_date ?> मा दिनुभएको दरखास्त बमोजिम यस कार्यालयबाट आवश्यक जाँचबुझ गरी बुझ्दा
              तपाईको देहाय
              बमोजिमको व्यक्तिसँग देहाय बमोजिमको नाता सम्बन्ध कायम रहेको देखिएकोले
              <?=$this->session->userdata('ward_no')?></b> नं वडा
              कार्यालयवाट प्राप्त सिफारीस पत्रको आधारमा तपाइको तथा तपाइको सबै नातेदारहरुको फोटो तथा रेखांत्मक सहिछाप
              प्रमाणित गरी स्थानीय सरकार
              सञ्चालन ऐन
            ...
            <table class="table letter-table table-bordered mt-4">
              ...
              <tbody>
                ...
                <tr>
                  <td><?= $i ?></td>
                  <td><?= $data->name ?> <?php if(!empty($data->death_date)){ ?>
                    (<?php echo $data->death_date;?>)<?php } ?></td>
                  <td><?= $relation->name ?></td>
                  <td><?= $data->add_cit_no?></td>
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="text-center b">ल्याप्चे सहिछाप</div>
                ...
                <table class="finger-table text-center table">
                  ...
                  <tr>
                    <td style="width:50px; height: 95px;">
              ...
              <div class="col-md-3" style="margin-left:513px;">
              ...
              <div class="col-3 offset-9 signature">
                <div>
                  ...
                  <input type="text" name="post" id="ward_post" class="form-control" style="margin-top:15px;"
                    value="<?= ($this_post != FALSE) ? 'वडा '.$this_post->name : 'वडा अध्यक्ष'?>">
                  <?php echo form_close();?>
                </div>
              </div>
            </div>

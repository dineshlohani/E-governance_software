<?php
    ...
    //$gender_spec = Modules::run("Settings/getGenderSpec",$result->gender_spec);
    ...
    $path           = base_url()."assets/documents/others/kotha_khali_suchana/";
    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url()?>kotha-khali-suchana/">कोठा खाली सूचना </a>
                </li>
            ...
            <div class="tab-content" id="nav-tabContent">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            ?>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>kotha-khali-suchana/edit/<?= $result->id ?>/">सम्पादन
                                                        गर्नुहोस्</a>
                                                </div>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>kotha-khali-suchana/darta/<?= $result->id ?>/">
                                                        दर्ता गर्नुहोस</a>
                                                </div>
                                                <?php
                                                }
                                            ...
                                            ?>
                                                ...
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>kotha-khali-suchana/chalani/<?= $result->id ?>/">
                                                        चलानी गर्नुहोस</a>
                                                </div>
                                                <?php
                                                }
                ...
                <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                    ...
                    <div class="text-right">
                        ...
                        <?php echo form_open(base_url().'kotha-khali-suchana/print/'.$result->id ,'target="_blank"'); ?>
                    ...
                    <div class="letter">
                        ...
                        <div class="text-justify">
                            उपरोक्त सम्बन्धमा यस वडा नं <b><?= $ward->name ?></b> (साबिकको

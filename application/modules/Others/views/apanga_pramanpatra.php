<?php
    ...
    {
    $action_page = "apanga-pramanpatra/create"; }
    if($this->uri->segment(2)=="edit")
    {
    $action_page = "apanga-pramanpatra/edit/".$this->uri->segment(3);
    }
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="col-md-6">
                               <div class="form-group row">
                                   <label class="col-md-4 col-form-label">
                                           <span class="float-right">
                                              अपांगताको किसिम<span class="text-danger">&nbsp;*</span>
                                           </span>

                                   </label>

                                       <div class="col-sm-8">
                                           <select name="disable_type" class="form-control select2" required>
                                               <option value="">छान्नुहोस्</option>
                                           <?php foreach($disables as $disable): ?>
                                               <option value="<?= $disable->id ?>"
                                                   <?php
                                                        if(isset($result) && $result->disable_type == $disable->id)
                                                        {

    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url()?>ghar-patala">घर पाताल भएको </a>
                </li>
                        ...
                        <table class="table table-bordered my-4">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $result->biggha."-".$result->kattha."-".$result->dhur."-".$result->daam ?></td>
                                </tr>
                                <tr>
                                    <td>
                                        ठेगाना
                            ...
                            <tbody>
                                <tr>
                                        ...
                                        <div class="row">
                                            ...
                                            if($result->status == 1) {
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    href="<?= base_url() ?>ghar-patala/edit/<?= $result->id ?>/">सम्पादन
                                                गर्नुहोस्</a>
                                            </div>
                                            <div class="col-lg-6">
                                                <a class="btn btn-success btn-submit  mt-3 btn-block  "
                                                href="<?= base_url() ?>ghar-patala/darta/<?= $result->id ?>/">
                                            दर्ता गर्नुहोस</a>
                                        </div>
                                        <?php
                                    }
                                    elseif ($result->status == 2) {
                                        ...
                                        <div class="col-lg-6">
                                            <a class="btn btn-success btn-submit mt-3 btn-block  "
                                            href="<?= base_url() ?>ghar-patala/chalani/<?= $result->id ?>/">
                                        चलानी गर्नुहोस</a>
                                    </div>
                                    <?php
                                }
...
<?php if($result->status != 1): ?>
    ...
    <div class="text-right">
        <?php if($result->status == 3 ) : ?>
            <?php echo form_open(base_url().'ghar-patala/print/'.$result->id ,'target="_blank"'); ?>
    ...
    <div class="letter">
        <div class="letter-head">
          ...
          <!-- ----------------------Modal End-------------- -->
          <div class="text-center font-26" style="margin-top: 70px; margin-bottom: 70px;">
            <h4>
                <span
    ...
    <div class="text-justify">
        ...
        पर्न आएको निवेदन
        सम्बन्धमा उल्लेखित कि.नं. बनेको घर पाताल भएको व्यहोरा सिफारिस गरिन्छ ।
    </div>
    <div class="mt-5 pt-3">
        <div class="row">

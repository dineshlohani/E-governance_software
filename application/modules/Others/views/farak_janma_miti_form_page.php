...
{
    $action_page = "farak-janma-miti/create";
}
if($this->uri->segment(2)=="edit")
{
    $action_page = "farak-janma-miti/edit/".$this->uri->segment(3);
}
    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url()?>mirtyu-darta/">फरक जन्ममिति </a></li>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                               फरक भएको जन्म मिति<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <input type="text" name="wrong_birthdate" maxlength="128" class="form-control" required id="nepaliDate5" value="<?= isset($result) ? $result->wrong_birthdate : ''?>" />
                                         </div>
                                     </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                हुनुपर्ने जन्म मिति<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <input type="text" name="right_birthdate" class="form-control" id="nepaliDate6" value="<?= isset($result) ? $result->right_birthdate : ''?>" required>
                                        </div>
                                     </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="wrong_document" maxlength="128" class="form-control" required id="id_wrong_document" value="<?= isset($result) ? $result->wrong_document : ''?>" />
                                    </div>
                                </div>
                            </div>
                        </div>

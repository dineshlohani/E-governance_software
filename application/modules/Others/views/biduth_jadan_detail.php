    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url()?>biduth-jadan"> बिधुत जडान प्रमाणपत्र </a>
                </li>
            ...
            <div class="tab-content" id="nav-tabContent">
                            ...
                            <table class="table table-bordered my-4 font-kalimati">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$result->gender_spec?> <?= $result->name ?></td>
                                    </tr>
                                    <tr>
                                        <td>
                                             निर्माण सम्पन्न
                                    ...
                                    <tr>
                                        <td>
                                            निर्माण स्वीकृति लिएको मिति
                                        </td>
                                        <td>
                                            <?= $result->nepali_date_1 ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div class="row">
                                                ...
                                                ?>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>biduth-jadan/edit/<?= $result->id ?>/">सम्पादन
                                                        गर्नुहोस्</a>
                                                </div>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>biduth-jadan/darta/<?= $result->id ?>/">
                                                        दर्ता गर्नुहोस</a>
                                                </div>
                                                <?php
                                                    }
                                                ...
                                                <div class="col-lg-6 ">
                                                    <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>biduth-jadan/chalani/<?= $result->id ?>/">
                                                        चलानी गर्नुहोस</a>
                                                </div>
                                                <?php
                                                    }
                ...
                <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                    ...
                    <div class="text-right">
                        ...
                        <?php echo form_open(base_url().'biduth-jadan/print/'.$result->id ,'target="_blank"'); ?>
                    ...
                    <div class="letter">
                        ...
                        <div class="text-center mt-2 pb-2">
                            <h4><span style="border-bottom: 1px solid black; margin-bottom: 3px;"> <span class="red"> बिषय:</span> बिजुली जडान सिफारिस । </span>
                            </h4>
                        </div>
                        ...
                        <form method="post" action="biduth_jadan_print.php">
                        <div class="mt-5 pt-3">
                            <div class="row">
                                <div class="col-3">
                                   <u>बोधार्थ:-</u><br>

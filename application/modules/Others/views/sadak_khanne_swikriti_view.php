            ...
            <div class="container-fluid ">
                <nav aria-label="breadcrumb" class="bg-shadow">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url()?>sadak-khanne-swikriti">सडक खन्ने स्वीकृती</a></li>
...
<div class="">
    <div class="row no-gutters">
        ...
        <div class="col-lg-9 col-12">
            ...
            <?php echo form_open(base_url().'sadak-khanne-swikriti', array('method'=>'get'));?>
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <div class="dropdown mr-sm-2">
                        ...
                        <div class="dropdown-menu search" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item"
                               href="<?= base_url()?>sadak-khanne-swikriti?month=3&submit=">पछिल्लो
                                तीन महिनाको</a>
                            <a class="dropdown-item"
                               href="<?= base_url()?>sadak-khanne-swikriti?month=6&submit=">पछिल्लो
                                छ महिनाको</a>
                            <a class="dropdown-item"
                               href="<?= base_url()?>sadak-khanne-swikriti?month=12&submit=">पछिल्लो
                                बाह्र महिनाको</a>
...
<form id='id_search_form' method='GET' action='<?= base_url()?>sadak-khanne-swikriti' class="form-inline ">
      <div class="input-group ">
        ...
        <div class="mr-sm-2" style="border-right: 1px solid #b3aaaa; padding-right: 20px;">
       ...
       <div class="dropdown">
            ...
            <ul class="dropdown-menu search" aria-labelledby="dropdownMenuButton">
                ...
                <li class="dropdown-item dropdown-submenu">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>sadak-khanne-swikriti?status=1&submit=">नवीनतम डाटा</a></div>
                </li>
                <li class="dropdown-item dropdown-submenu">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>sadak-khanne-swikriti?status=2&submit=">दर्ता भएको डाटा</a></div>
                </li>
                <li class="dropdown-item dropdown-submenu">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>sadak-khanne-swikriti?status=3&submit=">चलानी भएको डाटा</a></div>
                </li>
                <li class="dropdown-item dropdown-submenu" id="search_all">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>sadak-khanne-swikriti?status=0&submit=">सम्पूर्ण डाटा </a></div>
                </li>
            </ul>
        </div>
    </div>
                   ...
                   <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12 text-right">
                            ...
                            <a href="<?= base_url()?>sadak-khanne-swikriti/create" class="btn font-16 btn-lg btn-success">
                ...
                <table class="table table-responsive-sm table-responsive-md table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col"> स्वीकृती गरिएको सडकको नाम</th>
                        <th scope="col">निवेदन दिएको मिति</th>
                        <th scope="col">कार्य सम्पन्न गर्नुपर्ने दिन</th>
                        <th>स्वीकृत</th>
                    ...
                    <tbody>
                            ...
                            else
                            {
                                ...
                                foreach($result as $data)
                                {
                                    switch($data->status)
                                    {
                                        case 1:
                                            $status = "नभएको";
                                            $html   = '<a href="'.base_url().'sadak-khanne-swikriti/edit/'.$data->id.'" class="btn btn-warning">सम्पादन गर्नुहोस</a> |
                                                        <a href="'.base_url().'sadak-khanne-swikriti/darta/'.$data->id.'" class="btn btn-success">दर्ता गर्नुहोस</a>';
                                            break;
                                        case 2:
                                            $status ="भएको";
                                            $html   = '<a href="'.base_url().'sadak-khanne-swikriti/chalani/'.$data->id.'" class="btn btn-success">चलानी गर्नुहोस</a>';
                                            break;
                                        case 3:
                                            $status ="भएको";
                        ...
                        <tr>
                                <td> <?= $i?> </td>
                                <td><a href="<?= base_url()?>sadak-khanne-swikriti/detail/<?=$data->id?>"> <?= $data->form_id; ?> </a> </td>
                                <td> <?= $data->applicant_name ?> </td>
                                <td> <?= $local_body->name.", वार्ड-".$ward->name.", ".$district->name.", ".$state->name ?> </td>
                                <td>  <?= $data->road_name?> </td>
                                <td>  <?= $data->nep_applicated_date ?> </td>

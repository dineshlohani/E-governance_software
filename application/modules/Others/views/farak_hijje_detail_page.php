                    ...
                    <div class="row">
                        <div class="offset-lg-2 col-lg-8">
                            <table class="table table-bordered my-4">
                                ...
                                <tr>
                                    <td>फरक भएको अंग्रेजी हिज्जे</td>
                                    <td><?= $result->wrong_spelling?></td>
                                </tr>
                                <tr>
                                    <td>हुनु पर्ने अंग्रेजी हिज्जे</td>
                                    <td><?= $result->right_spelling?></td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <div class="row">
                                            ...
                                            if($result->status == 1) {
                                                ?>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>farak-hijje/edit/<?= $result->id ?>/">सम्पादन
                                                        गर्नुहोस्</a>
                                                </div>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>farak-hijje/darta/<?= $result->id ?>/">
                                                        दर्ता गर्नुहोस</a>
                                                </div>
                                                <?php
                                            }
                                            elseif ($result->status == 2) {
                                                ...
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>farak-hijje/chalani/<?= $result->id ?>/">
                                                        चलानी गर्नुहोस</a>
                                                </div>
                                                <?php
                                            }
                ...
                <?php if($result->status != 1): ?>
                    <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                        ...
                        <div class="text-right">
                            ...
                            <?php echo form_open(base_url().'farak-hijje/print/'.$result->id ,'target="_blank"'); ?>
                        ...
                        <div class="letter">
                            ...
                            <div class="text-center font-28" style="margin-bottom: 40px;">
                                <h4><span style="border-bottom: 1px solid black; margin-bottom: 5px;"> <span class="red"> बिषय : </span> फरक फरक अंग्रेजी हिज्जे ।</span>
                                </h4>
                            </div>
                            ...
                            <div class="text-justify">प्रस्तुत बिषयमा 
                                ...
                                हिज्जे भएको व्यक्ति एकै भएको प्रमाणित गरिन्छ ।
                            </div>
                            <div class='col-md-12'>

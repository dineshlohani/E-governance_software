<?php
    ...
    $path           = base_url()."assets/documents/others/add_classroom/";
                           ...
                           <div class="offset-lg-2 col-lg-8">
                               <table class="table table-bordered my-4">
                                   ...
                                   <tr>
                                       ...
                                       <td><?=$result->gender_spec?> <?= $result->school_name ?></td>
                                   </tr>
                                  <!--  <tr>
                                     <td>नागरिकता नं </td>
                                     <td><?=$result->cit_no?></td>
                                     ...
                                     <div class="row">
                                           ...
                                           ?>
                                                   <div class="col-lg-6">
                                                       <a class="btn btn-warning btn-submit mt-3 btn-block  "
                                                          href="<?= base_url() ?>add-classroom/edit/<?= $result->id ?>/">सम्पादन
                                                           गर्नुहोस्</a>
                                                   </div>
                                                   <div class="col-lg-6">
                                                       <a class="btn btn-success btn-submit  mt-3 btn-block  "
                                                          href="<?= base_url() ?>add-classroom/darta/<?= $result->id ?>/">
                                                           दर्ता गर्नुहोस</a>
                                                   </div>
                                           <?php
                                               }
                                           ...
                                           ?>
                                                  ...
                                                  <div class="col-lg-6">
                                                   ...
                                                   <div class="col-lg-6 ">
                                                       <a class="btn btn-success btn-submit mt-3 btn-block  "
                                                          href="<?= base_url() ?>add-classroom/chalani/<?= $result->id ?>/">
                                                           चलानी गर्नुहोस</a>
                                                   </div>
                                           <?php
                                               }
                       ...
                       <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab"
                           ...
                           <div class="text-right">
                              <?php if($result->status == 3 ) : ?>
                               <?php echo form_open(base_url().'add-classroom/print/'.$result->id ,'target="_blank"'); ?>
                           ...
                           <div class="letter">
                               ...
                               <div class="text-justify">
                                   ...
                                   अन्तर्गत रहेको <b><?= $result->school_name ?></b> को कक्षा थपको स्वीकृतिको लागि सिफारिस
                                   गरी पाऊँ भनी यस वडा कार्यालयमा पर्न आएको निवेदन सम्बन्धमा त्यहाँको नियमानुसार कक्षा
                                   थप स्वीकृतिको लागि सिफारिस गरी पठाइएको व्यहोरा अनुरोध गरिन्छ ।
                               </div>
                               <div class="mt-5 pt-3">
                                   <div class="row">

                    ...
                    <div class="row">
                        <div class="offset-lg-2 col-lg-8">
                            <table class="table table-bordered my-4">
                                ...
                                <tr>
                                    <td>बसोबासको किसिम</td>
                                    <td>
                                        <?= $resident_type ?> बसोबास
                                    </td>
                                </tr>
                                <tr>
                                    <td>आर्थिक अवस्था</td>
                                ...
                                <td colspan="2">
                                    <div class="row">
                                        ...
                                        if($result->status == 1) {
                                         ?>
                                         <div class="col-lg-6">
                                            <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>scholarship/edit/<?= $result->id ?>/">सम्पादन
                                            गर्नुहोस्</a>
                                        </div>
                                        <div class="col-lg-6">
                                            <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>scholarship/darta/<?= $result->id ?>/">
                                            दर्ता गर्नुहोस</a>
                                        </div>
                                        <?php
                                    }
                                    ...
                                    <div class="col-lg-6">
                                        <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>scholarship/chalani/<?= $result->id ?>/">
                                        चलानी गर्नुहोस</a>
                                    </div>
                                    <?php
                                }
    ...
    <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
        <div class="text-right">
            <?php if($result->status == 3 ) : ?>
                <?php echo form_open(base_url().'scholarship/print/'.$result->id ,'target="_blank"'); ?>
        ...
        <div class="letter">
            <div class="letter-head">
                ...
                <div class="text-center font-28" style="margin-bottom: 40px;">
                    <h4><span style="border-bottom: 1px solid black; margin-bottom: 5px;"> <span class="red"> बिषय : </span> छात्रवृत्ति सिफारिस ।</span>
                    </h4>
                </div>
                <div class="text-justify">
                    प्रस्तुत बिषयमा <b><?= $local_body->name ?></b> वडा नं <b><?= $ward->name ?></b> (साबिकको ठेगाना

    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url()?>farak-janma-miti">फरक जन्म मिति</a></li>
                    ...
                    <div class="row">
                        <div class="offset-lg-2 col-lg-8">
                            <table class="table table-bordered my-4">
                                ...
                                <tr>
                                    <td>फरक भएको जन्म मिति</td>
                                    <td><?= $result->wrong_birthdate?></td>
                                </tr>
                                <tr>
                                    <td>हुनु पर्ने जन्म मिति</td>
                                    <td><?= $result->right_birthdate?></td>
                                </tr>
                                <tr>
                                    <td>फरक भएको कागजात</td>
                                    <td><?= $result->wrong_document ?></td>
                                </tr>
                                    ...
                                    <td colspan="2">
                                        <div class="row">
                                            ...
                                            if($result->status == 1) {
                                                ?>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>farak-janma-miti/edit/<?= $result->id ?>/">सम्पादन
                                                        गर्नुहोस्</a>
                                                </div>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>farak-janma-miti/darta/<?= $result->id ?>/">
                                                        दर्ता गर्नुहोस</a>
                                                </div>
                                                <?php
                                            }
                                            elseif ($result->status == 2) {
                                                ...
                                                <div class="col-lg-6 offset-lg-6">
                                                    <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>farak-janma-miti/chalani/<?= $result->id ?>/">
                                                        चलानी गर्नुहोस</a>
                                                </div>
                                                <?php
                                            }
                ...
                <?php if($result->status == 3): ?>
                    <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                        ...
                        <div class="text-right">
                            <?php echo form_open(base_url().'farak-janma-miti/print/'.$result->id ,'target="_blank"'); ?>
                        ...
                        <div class="letter">
                            ...
                            <div class="text-center font-28" style="margin-bottom: 40px;">
                                <h4><span style="border-bottom: 1px solid black; margin-bottom: 5px;"> <span class="red"> बिषय : </span> फरक फरक जन्म मिति प्रमाणित ।</span>
                                </h4>
                            </div>
                            <div class="text-justify">प्रस्तुत बिषयमा 
                                ...
                                मनासिव भएकोले सो फरक जन्म मिति भएको व्यक्ति एकै भएको व्यहोरा सिफारिस गरिन्छ ।
                            </div>
                            <div class='col-md-12'>
                                <h4 class="text-center mb-5" style="margin-top:120px;">फरक जन्म मिति र कागजातको विवरण</h4>
                                <div class="row">

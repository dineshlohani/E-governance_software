<?php
    ...
    {
    $action_page = "court-fee/create"; }
    if($this->uri->segment(2)=="edit")
    {
    $action_page = "court-fee/edit/".$this->uri->segment(3);
    }
                ...
                <nav aria-label="breadcrumb" class="bg-shadow">
                    <ol class="breadcrumb px-3 py-2">
                        <li class="breadcrumb-item ml-1"><a href="<?= base_url()?>dashboard">गृह</a></li>
                            <li class="breadcrumb-item"><a href="<?= base_url()?>court-fee/">अदालत शुल्क मिनाह </a></li>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                पति/पत्नी को नाम<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                        <div class="col-sm-8">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                अदालतको नाम<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                        <div class="col-sm-8">
                                            <select name="court_name" class="form-control select2" required id="id_court_name">
                                                <option value="" selected>अदालत छान्नुहोस्</option>
                                                <?php foreach($districts as $district) : ?>
                                                    <option value="<?= $district->id ?>"
                                                        <?php
                                                          if(isset($result) && $result->court_name == $district->id)
                                                          {
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                मुद्धको प्रकार<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                        <div class="col-sm-8">
                                            <input type="text" name="case_type" maxlength="128" class="form-control" required id="id_case_type" value="<?= isset($result) ? $result->case_type :''?>"/>
                                        </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="old_place" class="select2 form-control" id="id_old_new_address">
                                            <option value="">छानुहोस</option>
                                            <?php foreach ($old_new_addresses as $data):?>
                                                <option value="<?= $data->id ?>"
                                                    <?php
                                                    if(isset($result)&& $result->old_place == $data->id)
                                                    {
                                                        echo 'selected="selected"';
                                                    }
                                                    ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                सर्जमिन गरेको मिति<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="nepali_visit_date" maxlength="10" class="form-control" required id="nepaliDate5" value="<?= isset($result) ? $result->nepali_visit_date : ''?>" />
                                            </div>
                                        </div>
                                </div>
                            </div>

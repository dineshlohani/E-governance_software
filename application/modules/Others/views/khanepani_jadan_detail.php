<?php
    ...
    $path           = base_url()."assets/documents/others/khanepani_jadan/";
    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url()?>khanepani-jadan"> खानेपानी जडान प्रमाणपत्र </a>
                </li>
            ...
            <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div class="row">
                                                ...
                                                ?>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>khanepani-jadan/edit/<?= $result->id ?>/">सम्पादन
                                                        गर्नुहोस्</a>
                                                </div>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>khanepani-jadan/darta/<?= $result->id ?>/">
                                                        दर्ता गर्नुहोस</a>
                                                </div>
                                                <?php
                                                    }
                                                ...
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>khanepani-jadan/chalani/<?= $result->id ?>/">
                                                        चलानी गर्नुहोस</a>
                                                </div>
                                                <?php
                                                    }
                ...
                <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                    ...
                    <div class="text-right">
                        ...
                        <?php echo form_open(base_url().'khanepani-jadan/print/'.$result->id ,'target="_blank"'); ?>
                    ...
                    <div class="letter">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 letter-head-center red">
                                    ...
                                    <div>
                                        ...
                                        <h2> <?= SITE_PALIKA ?> </h2>
                                        <?php else: ?>
                                        <h2><?=$this->session->userdata('ward_no')?> <?= SITE_WARD_OFFICE ?></h2>
                                        <?php endif; ?>
                        ...
                        <div class="text-center mt-2 pb-2">
                            <h4><span style="border-bottom: 1px solid black; margin-bottom: 3px;"> <span class="red"> बिषय:</span> धारा जडान सिफारिस । </span>
                            </h4>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                प्रस्तुत बिषयमा यस <b><?= $org_local_body->name ?>,</b> वार्ड-<b><?= $org_ward->name ?>
                                ...
                                <b><?=$result->gender_spec?> <?= $result->applicant_name ?></b> को नाममा खानेपानी लाईन जडान गरिदिन हुन सिफारिस साथ अनुरोध गरिन्छ।

                            </div>

                        </div>
                        <div class="text-center mt-5">
                            <h4>कित्ता नं को विवरण</h4>
                        ...
                        <form method="post" action="khanepani_jadan_print.php">
                        <div class="mt-5 pt-3">
                            <div class="row">
                                <div class="col-3">
                                    <u>बोधार्थ:-</u>
                                    ...
                                    <input type="text" name="name3" placeholder="Enter Name">
                                    <input type="text" name="name4" placeholder="Enter Name">
                                    <input type="text" name="name5" placeholder="Enter Name">
                                </div>
                                </form>

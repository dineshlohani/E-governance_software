            ...
            <div class="container-fluid ">
                <nav aria-label="breadcrumb" class="bg-shadow">
                    <ol class="breadcrumb px-3 py-2">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url()?>prabhidik-mulyankan">प्राविधिक मुल्यांकन </a>
                        </li>
                            ...
                            <div class="offset-lg-2 col-lg-8">
                                <table class="table table-bordered my-4">
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $result->nepali_chalani_date ?></td>
                                    </tr>
                                        ...
                                        <td colspan="2">
                                            <div class="row">
                                                ...
                                                ?>
                                                        <div class="col-lg-6">
                                                            <a class="btn btn-warning btn-submit mt-3 btn-block  "
                                                               href="<?= base_url() ?>prabhidik-mulyankan/edit/<?= $result->id ?>/">सम्पादन
                                                                गर्नुहोस्</a>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <a class="btn btn-success btn-submit  mt-3 btn-block  "
                                                               href="<?= base_url() ?>prabhidik-mulyankan/darta/<?= $result->id ?>/">
                                                                दर्ता गर्नुहोस</a>
                                                        </div>
                                                <?php
                                                    }
                                                ...
                                                ?>
                                                        ...
                                                        <div class="col-lg-6 ">
                                                            <a class="btn btn-success btn-submit mt-3 btn-block  "
                                                               href="<?= base_url() ?>prabhidik-mulyankan/chalani/<?= $result->id ?>/">
                                                                चलानी गर्नुहोस</a>
                                                        </div>
                                                <?php
                                                    }
                    ...
                    <?php if($result->status != 1): ?>
                        <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab"
                            ...
                            <div class="text-right">
                                ...
                                <?php echo form_open(base_url().'prabhidik-mulyankan/print/'.$result->id ,'target="_blank"'); ?>
                            ...
                            <div class="letter">
                                ...
                                <!-- ----------------------Modal End-------------- -->
                                <div class="text-center font-28" style="margin-top: 20px; margin-bottom: 50px;">
                                    <h4>
                                <span
                                        style="border-bottom: 1px solid black; margin-bottom: 5px;"> <span class="red"> बिषय: </span> खुलाई पठाएको ।
                            </span>

                                    </h4>
                                </div>
                                <div class="text-justify" style="text-indent: 150px;">
                                    तहाँ सम्मानित अदालतको मिति <b><?= $result->nepali_chalani_date ?></b>

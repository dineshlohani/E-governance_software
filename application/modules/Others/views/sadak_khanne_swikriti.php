<?php
    ...
    {
    $action_page = "sadak-khanne-swikriti/create";
    }
    if($this->uri->segment(2)=="edit")
    {
    $action_page = "sadak-khanne-swikriti/edit/".$this->uri->segment(3);
    }
                        ...
                        <div class="row">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                निवेदक<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                        <div class="col-sm-6">
                                            <select name="applic" class="form-control" required id="applic">
                                                  <option value="" selected>---Select---</option>
                                                  <option value="1">संस्था</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                निवेदकको लिङ्ग<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                        <div class="col-sm-8">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="old_place" class="select2 form-control" id="old_place">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                               निवेदन दिएको मिति<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="nep_applicated_date" maxlength="10" class="form-control" required id="nepaliDate5" value="<?= isset($result) ? $result->nep_applicated_date : ''?>" />
                                            </div>
                                        </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                कार्य सम्पन्न गर्नुपर्ने दिन<span class="text-danger">&nbsp;*</span>
                                            </span>

                                    </label>
                                        <div class="col-sm-8">
                                            <input type="number" name="completion_time" class="form-control" required min="0" id="id_completion_time" value="<?= isset($result) ? $result->completion_time : ''?>" />
                                        </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                               स्विकृत गरिएको सडकको <br> नाम<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                        <div class="col-sm-8">
                                            <input type="text" name="road_name" maxlength="256" class="form-control" required id="id_road_name" value="<?= isset($result) ? $result->road_name : ''?>"/>
                                        </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                स्विकृत गरिएको ईकाइ<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                        <div class="col-sm-8">
                                            <input type="number" name="road_quantity" id="id_road_quantity" class="form-control" required min="1" step="0.01" value="<?= isset($result) ? $result->road_quantity : ''?>" />
                                        </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                               धरौटी रकम<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                        <div class="col-sm-8">
                                            <input type="number" name="refundable_amount" id="id_refundable_amount" class="form-control" required min="1" step="0.01" value="<?= isset($result) ? $result->refundable_amount : ''?>" />
                                        </div>
                                </div>
                            </div>
                        </div>

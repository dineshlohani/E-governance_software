<?php
    ...
    {
    $action_page = "ghar-patala/create"; }
    if($this->uri->segment(2)=="edit")
    {
    $action_page = "ghar-patala/edit/".$this->uri->segment(3);
    }
    ...
    $path           = base_url()."assets/documents/others/ghar_patala/";
?>
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                           <div class="col-md-6">
                               <select name="gender_spec" style="margin-left: 165px">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                               आवेदकको नाम<span class="text-danger">&nbsp;*</span>
                                            </span>
                                    </label>
                                        <div class="col-sm-8">
                            ...
                            <label class="col-md-2 col-form-label">
                                ...
                                <div class="col-10">
                                    <div class="input-group mb-3">
                                        <input type="number" name="biggha" value="<?= isset($result) ? $result->biggha : 0?>" class="form-control" required min="0" id="id_biggha" />
                                        <div class="input-group-append ">
                                            <span class="input-group-text" id="basic-addon2">रोपनी</span>
                                        </div>
                                        <input type="number" name="kattha" value="<?= isset($result) ? $result->kattha : 0?>" class="form-control" required min="0" id="id_kattha" />
                                        <div class="input-group-append ">
                                            <span class="input-group-text" id="basic-addon2">आना</span>
                                        </div>
                                        <input type="number" name="dhur" value="<?= isset($result) ? $result->dhur : 0?>" class="form-control" required min="0" id="id_dhur" />
                                        <div class="input-group-append ">
                                            <span class="input-group-text" id="basic-addon2">पैसा</span>
                                        </div>
                                        <input type="number" name="daam" value="<?= isset($result) ? $result->daam : 0?>" class="form-control" required min="0" id="id_daam" />
                                        <div class="input-group-append ">
                                            <span class="input-group-text" id="basic-addon2">दाम</span>
                                        </div>
                                    </div>
                                </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="old_place" class="form-control select2">

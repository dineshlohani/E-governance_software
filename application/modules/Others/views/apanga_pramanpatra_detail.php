...
$path           = base_url()."assets/documents/others/apanga_pramanpatra/";
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="row">
                                                ...
                                                if($result->status == 1) {
                                                    ?>
                                                    <div class="col-lg-6">
                                                        <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>apanga-pramanpatra/edit/<?= $result->id ?>/">सम्पादन
                                                        गर्नुहोस्</a>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>apanga-pramanpatra/darta/<?= $result->id ?>/">
                                                        दर्ता गर्नुहोस</a>
                                                    </div>
                                                    <?php
                                                }
                                                elseif ($result->status == 2) {
                                                    ...
                                                    <div class="col-lg-6">
                                                        <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>apanga-pramanpatra/chalani/<?= $result->id ?>/">
                                                        चलानी गर्नुहोस</a>
                                                    </div>
                                                    <?php
                                                }
                ...
                <?php if($result->status != 1): ?>
                    <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                        ...
                        <div class="text-right">
                            ...
                            <?php echo form_open(base_url().'apanga-pramanpatra/print/'.$result->id ,'target="_blank"'); ?>

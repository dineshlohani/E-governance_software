<?php
    ...
    {
    $action_page = "janma-miti-pramanit/create";
    }
    if($this->uri->segment(2)=="edit")
    {
    $action_page = "janma-miti-pramanit/edit/".$this->uri->segment(3);
    }
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                               बच्चाको नाम<span class="text-danger">&nbsp;*</span>
                                            </span>

                                    </label>

                                        <div class="col-sm-8">
                                            <input type="text" name="child_name" maxlength="128" class="form-control" required id="id_child_name" value="<?= isset($result) ? $result->child_name : ''?>" />
                                        </div>
                                    ...
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="gender" class="form-control" required id="id_gender">
                                                ...
                                                <option value="1" <?php if(isset($result) && $result->gender == 1){ echo 'selected="selected"';}?>>छोरा</option>

                                                <option value="2" <?php if(isset($result) && $result->gender == 2){ echo 'selected="selected"';}?>>छोरी</option>
                        ...
                        <div class="row">
                            <div class="col-md-6 ">
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label"><span
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="nepali_dob" maxlength="10" class="form-control" required id="nepaliDate5" value="<?= isset($result) ? $result->nepali_dob : ''?>" />
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                जन्मस्थान<span class="text-danger">&nbsp;*</span>
                                            </span>

                                    </label>

                                        <div class="col-sm-8">
                                            <input type="text" name="birth_place" maxlength="252" class="form-control" required id="id_birth_place" value="<?= isset($result) ? $result->birth_place : ''?>" />
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                नागरिकता/राहदानी नं<span class="text-danger">&nbsp;*</span>
                                            </span>

                                    </label>

                                        <div class="col-sm-8">
                                            <input type="text" name="father_citizenship_no" maxlength="128" class="form-control" required id="id_father_citizenship_no"  value="<?= isset($result) ? $result->father_citizenship_no : ''?>"/>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="mother_citizenship_no" maxlength="128" class="form-control" required id="id_mother_citizenship_no" value="<?= isset($result) ? $result->mother_citizenship_no : ''?>" />
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                सूचकको नाम<span class="text-danger">&nbsp;*</span>
                                            </span>

                                    </label>

                                        <div class="col-sm-8">
                                            <input type="text" name="suchak_name" maxlength="128" class="form-control" required id="id_suchak_name"  value="<?= isset($result) ? $result->suchak_name : ''?>"/>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="suchak_citizenship_no" maxlength="128" class="form-control" required id="id_suchak_citizenship_no" value="<?= isset($result) ? $result->suchak_citizenship_no : ''?>" />
                                        </div>

<?php
    ...
    {
    $action_page = "farak-nam-thar/create";
    }
    if($this->uri->segment(2)=="edit")
    {
    $action_page = "farak-nam-thar/edit/".$this->uri->segment(3);
    }
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                फरक भएको कागजात<span class="text-danger">&nbsp;*</span>
                                            </span>

                                    </label>

                                        <div class="col-sm-8">
                                            <input type="text" name="farak_bhayeko_document" maxlength="128" class="form-control" required id="id_farak_bhayeko_document" value="<?= isset($result) ? $result->farak_bhayeko_document :''?>"/>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                ठिक भएको कागजात<span class="text-danger">&nbsp;*</span>
                                            </span>

                                    </label>

                                        <div class="col-sm-8">
                                            <input type="text" name="thik_bhayeko_document" maxlength="128" class="form-control" required id="id_thik_bhayeko_document" value="<?= isset($result) ? $result->thik_bhayeko_document :''?>"/>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                             फरक भएको<span class="text-danger">&nbsp;*</span>
                                            </span>

                                    </label>

                                        <div class="col-sm-8">
                                            <input type="text" name="farak_name" maxlength="128" class="form-control" required id="id_farak_name" value="<?= isset($result) ? $result->farak_name :''?>" />
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                            हुनु पर्ने<span class="text-danger">&nbsp;*</span>
                                            </span>

                                    </label>

                                        <div class="col-sm-8">
                                            <input type="text" name="thik_naam" maxlength="128" class="form-control" required id="id_thik_naam" value="<?= isset($result) ? $result->thik_naam :''?>" />
                                        </div>

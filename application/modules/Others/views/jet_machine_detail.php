...
<section class="content ">
        ...
        <div class="container-fluid font-kalimati">
            <div class="bd-example bd-example-tabs">
                        ...
                        <div class="row">
                            <div class="offset-lg-2 col-lg-8">
                                <table class="table table-bordered my-4">
                                    ...
                                    <tr>
                                        <td>मेशिन उपलब्द गराउनुपर्ने स्थान</td>
                                        <td>
                                            <?= $result->machine_dine_tham ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>बाटोको नाम</td>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div class="row">
                                                ...
                                                ?>
                                                        <div class="col-lg-6">
                                                            <a class="btn btn-warning btn-submit mt-3 btn-block  "
                                                               href="<?= base_url() ?>jet-machine/edit/<?= $result->id ?>/">सम्पादन
                                                                गर्नुहोस्</a>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <a class="btn btn-success btn-submit  mt-3 btn-block  "
                                                               href="<?= base_url() ?>jet-machine/darta/<?= $result->id ?>/">
                                                                दर्ता गर्नुहोस</a>
                                                        </div>
                                                <?php
                                                    }
                                                ...
                                                ?>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <a class="btn btn-success btn-submit mt-3 btn-block  "
                                                               href="<?= base_url() ?>jet-machine/chalani/<?= $result->id ?>/">
                                                                चलानी गर्नुहोस</a>
                                                        </div>
                                                <?php
                                                    }
                ...
                <?php if($result->status != 1): ?>
                    <div class="tab-pane fade" id="sifaris" role="tabpanel"
                         aria-labelledby="nav-profile-tab"
                         aria-expanded="false">

                        <div class="text-right">
                            <?php if($result->status == 3 ) : ?>
                            <?php echo form_open(base_url().'jet-machine/print/'.$result->id ,'target="_blank"'); ?>
                        ...
                        <div class="letter">
                            ...
                            <!-- ----------------------Modal End-------------- -->
                            <div class="text-center font-28 mb-3"
                                 style="margin-top: 50px; margin-bottom: 30px;">
                                <h4><span
                                        style="border-bottom: 1px solid black; margin-bottom: 5px;"> <span class="red"> बिषय : </span> जेट मेशिन।</span>
                                </h4>
                            </div>
                            ...
                            <div class="text-justify"
                                 style="margin-top: 10px; text-indent: 150px;">
                            ...
                            <div class="mt-4" style="font-style:italic;">
                                ...
                                बाटोको नाम : <b><?= $result->road_name ?></b>
                            </div>

...
$path           = base_url()."assets/documents/others/arthik_saheta/";
    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url()?>arthik-saheta/">आर्थिक सहायता </a>
                </li>
                    ...
                    <table class="table table-bordered my-4">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $result->culprit_name ?></td>
                            </tr>
                            <tr>
                                <td>
                                    आपराधिको नागरिकता नं 
                                </td>
                                <td><?= $result->ap_cit_no ?></td>
                            </tr>
                            <tr>
                                <td>
                                    ठेगाना
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <div class="row">
                                        ...
                                        if($result->status == 1) {
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                href="<?= base_url() ?>arthik-saheta/edit/<?= $result->id ?>/">सम्पादन
                                            गर्नुहोस्</a>
                                        </div>
                                        <div class="col-lg-6">
                                            <a class="btn btn-success btn-submit  mt-3 btn-block  "
                                            href="<?= base_url() ?>arthik-saheta/darta/<?= $result->id ?>/">
                                        दर्ता गर्नुहोस</a>
                                    </div>
                                    <?php
                                }
                                ...
                                <div class="col-lg-6 offset-lg-6">
                                    <a class="btn btn-success btn-submit mt-3 btn-block  "
                                    href="<?= base_url() ?>arthik-saheta/chalani/<?= $result->id ?>/">
                                चलानी गर्नुहोस</a>
                            </div>
                            <?php
                        }
...
<?php if($result->status != 1): ?>
    ...
    <div class="text-right">
        <?php if($result->status == 3 ) : ?>
            <?php echo form_open(base_url().'arthik-saheta/print/'.$result->id ,'target="_blank"'); ?>
    ...
    <div class="text-justify">
        उपरोक्त सम्बन्धमा <b><?= $local_body->name ?></b> वडा नं <b><?= $ward->name ?></b>
        बस्ने <?=$result->gender_spec?> <b><?= $result->applicant_name ?>, <?= $result->culprit_name ?></b> बाट
        पिडित भई उपचाररत रहेकोमा आर्थिक अवस्था कमजोर भई उपचारमा समस्या पर्न गएकोले आर्थिक
        सहायता उपलब्ध गराई पाउन सिफारिस गरी पाउँ भनी यस वडा कार्यालयमा पर्न आएको निवेदन
        सम्बन्धमा बुझ्दा व्यहोरा मनासिव बुझिएकोले त्यहाँ को नियमानुसार आर्थिक सहायता उपलब्ध
        गराईदिनुहुन सिफारिस गरिन्छ ।
    </div>

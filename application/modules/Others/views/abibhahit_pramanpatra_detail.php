...
$path           = base_url()."assets/documents/others/abibhahit_pramanpatra/";
if($result->gender == 1)
{
    $gender = "छोरा";
}
                            ...
                            <table class="table table-bordered my-4">
                                <tbody>
                                 ...
                                 <tr class="text-center font-bold font-20">
                                    <td colspan="2">
                                        आबदेकको विवरण (अविवाहित प्रमाणपत्र)
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <td colspan="2">
                                    ...
                                    <div class="row">
                                        ...
                                        if($result->status == 1) {
                                         ?>
                                         <div class="col-lg-6">
                                            <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>abibhahit-pramanpatra/edit/<?= $result->id ?>/">सम्पादन
                                            गर्नुहोस्</a>
                                        </div>
                                        <div class="col-lg-6">
                                            <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>abibhahit-pramanpatra/darta/<?= $result->id ?>/">
                                            दर्ता गर्नुहोस</a>
                                        </div>
                                        <?php
                                    }
                                    elseif ($result->status == 2) {
                                     ...
                                     <div class="col-lg-6">
                                        <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>abibhahit-pramanpatra/chalani/<?= $result->id ?>/">
                                        चलानी गर्नुहोस</a>
                                    </div>
                                    <?php
                                }
...
<?php if($result->status != 1): ?>
    <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
        ...
        <div class="text-right">
            ...
            <?php echo form_open(base_url().'abibhahit-pramanpatra/print/'.$result->id ,'target="_blank"'); ?>
        ...
        <div class="letter">
            <div class="letter-head">
                ...
                <div class="row">
                    ...
                    <!-- ----------------------Modal End-------------- -->
                    <div class="text-center font-28" style="margin-top: 50px; margin-bottom: 70px;">
                        <h4><span style="border-bottom: 1px solid black; margin-bottom: 5px;"> <span class="red"> बिषय:</span> अविवाहित प्रमाणित। </span>
                        </h4>
                    </div>


                    <div class="text-justify" style="text-indent: 120px;">
                        प्रस्तुत बिषयमा <?= $local_body->name ?> वडा नं. <?= $ward->name ?> (साविकको 
                        ठेगाना <?= $old_place->name ?>) निवासी श्री <?= $result->father_name ?> तथा
                        श्रीमती <?= $result->mother_name ?>को <?= $gender ?> 
                            ...
                            ?>
                        <?= $result->child_name ?>
                        यस कार्यालयबाट स्थलगत सर्जमिन गरिबुझ्दा आजको
                        मितिसम्म
                        अविवाहित रहेको व्यहोरा प्रमाणित गरिन्छ ।
                    </div>

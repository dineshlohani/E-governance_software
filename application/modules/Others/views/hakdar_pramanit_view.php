...
<div class="">
    <div class="row no-gutters">
        ...
        <div class="col-lg-9 col-12">
            ...
            <?php echo form_open(base_url().'hakdar-pramanit', array('method'=>'get'));?>
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <div class="dropdown mr-sm-2">
                        ...
                        <div class="dropdown-menu search" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item"
                               href="<?= base_url()?>hakdar-pramanit?month=3&submit=">पछिल्लो
                                तीन महिनाको</a>
                            <a class="dropdown-item"
                               href="<?= base_url()?>hakdar-pramanit?month=6&submit=">पछिल्लो
                                छ महिनाको</a>
                            <a class="dropdown-item"
                               href="<?= base_url()?>hakdar-pramanit?month=12&submit=">पछिल्लो
                                बाह्र महिनाको</a>
...
<form id='id_search_form' method='GET' action='<?= base_url()?>hakdar-pramanit' class="form-inline ">
       ...
       <div class="dropdown">
            ...
            <ul class="dropdown-menu search" aria-labelledby="dropdownMenuButton">
                ...
                <li class="dropdown-item dropdown-submenu">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>hakdar-pramanit?status=1&submit=">नवीनतम डाटा</a></div>
                </li>
                <li class="dropdown-item dropdown-submenu">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>hakdar-pramanit?status=2&submit=">दर्ता भएको डाटा</a></div>
                </li>
                <li class="dropdown-item dropdown-submenu">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>hakdar-pramanit?status=3&submit=">चलानी भएको डाटा</a></div>
                </li>
                <li class="dropdown-item dropdown-submenu" id="search_all">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>hakdar-pramanit?status=0&submit=">सम्पूर्ण डाटा </a></div>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12 text-right">
                            ...
                            <a href="<?= base_url()?>hakdar-pramanit/create" class="btn font-16 btn-lg btn-success">
                ...
                <table class="table table-responsive-sm table-responsive-md table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col">आवेदकको ठेगाना</th>
                        <th scope="col">मृतकको नाम</th>
                        <th scope="col">हकदारको संख्या</th>
                        <th>स्वीकृत</th>
                    ...
                    <tbody>
                            ...
                            else
                            {
                                ...
                                foreach($result as $data)
                                {
                                    switch($data->status)
                                    {
                                        case 1:
                                            $status = "नभएको";
                                            $html   = '<a href="'.base_url().'hakdar-pramanit/edit/'.$data->id.'" class="btn btn-warning">सम्पादन गर्नुहोस</a> |
                                                        <a href="'.base_url().'hakdar-pramanit/darta/'.$data->id.'" class="btn btn-success">दर्ता गर्नुहोस</a>';
                                            break;
                                        case 2:
                                            $status ="भएको";
                                            $html   = '<a href="'.base_url().'hakdar-pramanit/chalani/'.$data->id.'" class="btn btn-success">चलानी गर्नुहोस</a>';
                                            break;
                                        case 3:
                                            $status ="भएको";
                        ...
                        <tr>
                                <td> <?= $i?> </td>
                                <td><a href="<?= base_url()?>hakdar-pramanit/detail/<?=$data->id?>"> <?= $data->form_id; ?> </a> </td>
                                <td> <?= $data->applicant_name ?> </td>
                                <td> <?= $local_body->name.", वार्ड-".$ward->name.", ".$district->name.", ".$state->name ?> </td>
                                <td>  <?= $data->mritak_ko_name?> </td>
                                <td>  <?= $data->hakdar_ko_no ?> </td>
                                <td> <?= $status ?> </td>
                                <td> <?= $html ?>  </td>
                        </tr>
                        <?php

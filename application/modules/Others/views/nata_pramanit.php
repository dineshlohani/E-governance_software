...
{
    $action_page = "nata-pramanit/create";
}
if($this->uri->segment(2)=="edit")
{
    $action_page = "nata-pramanit/edit/".$this->uri->segment(3);
}
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-4">
                <select class="gender_spec" name="gender_spec" style="margin-left: 165px">
              ...
              <div class="col-md-4">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="cit_no" maxlength="128" class="form-control" required id="id_cit_no"
          ...
          <div class="col-md-12">
            <div class="form-group row">
              ...
              <div class="col-md-3 mb-sm-2">
                <select name="district" class="form-control select2 district_selected" required
              ...
              <div class="col-md-3 mb-sm-2">
                <select name="local_body" class="form-control select2 local_body_selected" required
            ...
            <table class="table form-table table-bordered table-sm">
              ...
              <tbody>
                ...
                <tr class="item" id="div_0">
                  <td>
                    <input type="text" name="name[]" maxlength="120" class="form-control formset-field"
                      id="id_details-0-name" value="<?= $data->name ?>" required />
                  </td>
                  <td>
                  ...
                  <td>
                    <input type="text" name="add_cit_no[]" maxlength="120" class="form-control formset-field"
                      id="id_cit_no" value="<?= $data->add_cit_no?>" required />
                  </td>
                  <td>
                    <textarea name="death_date[]" rows="2" class="form-control formset-field" id="death_date"
                      required><?= $data->death_date?></textarea>
                  </td>
                  <td>
                    <button type="button" class="btn btn-danger btn-sm remove" id="remove_0">
                    </button>
                  </td>
                </tr>
                <?php

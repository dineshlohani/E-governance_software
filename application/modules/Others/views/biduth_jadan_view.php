...
<section class="content ">
        ...
        <li class="breadcrumb-item"><a href="<?= base_url()?>biduth-jadan">बिधुत जडान दर्ता प्रमाणपत्र</a></li>
...
<div class="">
    <div class="row no-gutters">
        ...
        <div class="col-lg-9 col-12">
            ...
            <?php echo form_open(base_url().'biduth-jadan', array('method'=>'get'));?>
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <div class="dropdown mr-sm-2">
                        ...
                        <div class="dropdown-menu search" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item"
                               href="<?= base_url()?>biduth-jadan?month=3&submit=">पछिल्लो
                                तीन महिनाको</a>
                            <a class="dropdown-item"
                               href="<?= base_url()?>biduth-jadan?month=6&submit=">पछिल्लो
                                छ महिनाको</a>
                            <a class="dropdown-item"
                               href="<?= base_url()?>biduth-jadan?month=12&submit=">पछिल्लो
                                बाह्र महिनाको</a>
...
<form id='id_search_form' method='GET' action='<?= base_url()?>biduth-jadan' class="form-inline ">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu search" aria-labelledby="dropdownMenuButton">
                ...
                <li class="dropdown-item dropdown-submenu">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>biduth-jadan?status=1&submit=">नवीनतम डाटा</a></div>
                </li>
                <li class="dropdown-item dropdown-submenu">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>biduth-jadan?status=2&submit=">दर्ता भएको डाटा</a></div>
                </li>
                <li class="dropdown-item dropdown-submenu">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>biduth-jadan?status=3&submit=">चलानी भएको डाटा</a></div>
                </li>
                <li class="dropdown-item dropdown-submenu" id="search_all">
                    <div class="submenu-head"><a tabindex="-1" href="<?= base_url()?>biduth-jadan?status=0&submit=">सम्पूर्ण डाटा </a></div>
                </li>
            </ul>
        </div>
     </div>
                    ...
                    <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12 text-right">
                            ...
                            <a href="<?= base_url()?>biduth-jadan/create" class="btn font-16 btn-lg btn-success">
                ...
                <table class="table table-responsive-sm table-responsive-md table-bordered">
                    ...
                    <tbody>
                            ...
                            else
                            {
                                ...
                                foreach($result as $data)
                                {
                                    switch($data->status)
                                    {
                                        case 1:
                                            $status = "नभएको";
                                            $html   = '<a href="'.base_url().'biduth-jadan/edit/'.$data->id.'" class="btn btn-warning">सम्पादन गर्नुहोस</a> |
                                                        <a href="'.base_url().'biduth-jadan/darta/'.$data->id.'" class="btn btn-success">दर्ता गर्नुहोस</a>';
                                            break;
                                        case 2:
                                            $status ="भएको";
                                            $html   = '<a href="'.base_url().'biduth-jadan/chalani/'.$data->id.'" class="btn btn-success">चलानी गर्नुहोस</a>';
                                            break;
                                        case 3:
                                            $status ="भएको";
                        ...
                        <tr>
                                <td> <?= $i?> </td>
                                <td><a href="<?= base_url()?>biduth-jadan/detail/<?=$data->id?>"> <?= $data->form_id; ?> </a> </td>
                                <td> <?= $data->name ?> </td>
                                <td> <?= $data->kitta_no ?> </td>

...
class Mdl_tin_pusta_pramanit_detail extends CI_Model
{
    /*------------------------------------------------------------------------------------------------------------------*/
    private $_tableName = "tin_pusta_pramanit_detail";
    /*------------------------------------------------------------------------------------------------------------------*/
...
//        $this->db->order_by("id", "asc");
    ...
    {
//        $this->db->where('type="fox" OR type="dog"');
        $query = $this->db->get_where($this->_tableName, array('detail_id' => $id));
    ...
    {
        if ($query = $this->db->delete($this->_tableName, array('detail_id' => $id))) {
            return true;
        } else {
            return false;
        }

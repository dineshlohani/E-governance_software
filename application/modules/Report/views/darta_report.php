                                           ...
                                           // print_r($patra_name);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo base_url()?>Report/viewDartaBook/<?php echo $darta->uri?>" class="btn btn-info" style="color:#fff">दर्ता सुची हेर्नुहोस्</a>
                                                <?php endif;?>
                                                </td>
                                            </tr>
                                        <?php endforeach;endif;?>
...
<script type="text/javascript">
    $(document).ready(function(){
        $(document).on('click', '.search', function(){
            ...
            $.ajax({
                url:"<?php echo base_url()?>search-report",
                method:"POST",
                data:{
                    from_date:from_date,
                    to_date:to_date,

              ...
              <?php if(!empty($this->session->flashdata('msg')))
               ...
               <div class="row">
                                          ...
                                          <span class="float-right">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="input-group mb-sm-2">
                                                    ...
                                                    <input type="text" name="nep_dob" value="<?=isset($result)?$result->nep_dob:''?>" maxlength="10" class="form-control nep_dob" required id="nepaliDate3" />
                                                    <div class="input-group-append">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12 mb-3">
                            <h4>
                                नागरिकता प्र.प.को विवरण (Citizenship Certificate's Details)
                            </h4>
                            <hr style="border: 1px solid #adadad">
                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-6 col-form-label">
                                          <span class="float-right">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="citizenship_no" value="<?=isset($result)?$result->citizenship_no:''?>" maxlength="32" class="form-control" id="id_citizenship_no" />
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-6 col-form-label">
                                          <span class="float-right">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="citizenship_reg_date" value="<?=isset($result)?$result->citizenship_reg_date:''?>" maxlength="16" class="form-control" id="nepaliDate4" />
                                            </div>
                                          ...
                                          <span class="float-right">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="citizenship_type" class="form-control" id="id_citizenship_type">
                                                    ...
                                                    <option value="1" <?php if(isset($result) && $result->citizenship_type==1){?>selected="selected"<?php } ?>>वंसज</option>

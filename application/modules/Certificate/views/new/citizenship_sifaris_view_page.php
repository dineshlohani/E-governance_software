            ...
            <div class="body">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12 text-right">
                        ...
                        <a href="<?= base_url()?>citizenship-sifaris/create"  class="btn font-16 btn-lg btn-success">
                ...
                <table class="table table-responsive-sm table-responsive-md table-bordered"  style="width:100%;">
                    ...
                    <tr>
                        ...
                        <th scope="col">निवेदकको नाम</th>
                        <th scope="col">सिफारिस गर्नुपर्नेको नाम</th>
                    ...
                    else
                    {
                        ...
                        foreach($result as $data)
                        {
                            switch($data->status)
                            {
                                case 1:
                                    $status = "नभएको";
                                    $html   = '<a href="'.base_url().'citizenship-sifaris/edit/'.$data->id.'" class="btn btn-warning">सम्पादन गर्नुहोस</a> |
                                                        <a href="'.base_url().'citizenship-sifaris/darta/'.$data->id.'" class="btn btn-success">दर्ता गर्नुहोस</a>';
                                    break;
                                case 2:
                                    $status ="भएको";
                                    $html   = '<a href="'.base_url().'citizenship-sifaris/chalani/'.$data->id.'" class="btn btn-success">चलानी गर्नुहोस</a>';
                                    break;
                                case 3:
                                    $status ="भएको";
                            ...
                            <tr>
                                <td> <?= $i?> </td>
                                <td><a href="<?= base_url()?>citizenship-sifaris/detail/<?=$data->id?>"> <?= $data->form_id; ?> </a> </td>

    ...
    <div class="card">
      <div class="card-body">
              ...
              <div class="col-sm-6">
                <div class="input-group">
                  <input type="text" name="nepali_date" placeholder="YYYY-MM-DD" maxlength="10" class="form-control"
                    required id="nepaliDate5" value="<?=(isset($result))? $result->nepali_date:''?>" />
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <select name="cit_type">
                  ...
                  <option value="जन्म" <?php if(isset($result) && $result->cit_type == "जन्म"){ echo 'selected';}?>>जन्म
                  </option>
                  <option value="वंशज" <?php if(isset($result) && $result->cit_type == "वंशज"){ echo 'selected';}?>>वंशज
                  </option>
                </select>
              </div>
            </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-3 mb-sm-2">
                    <input type="text" name="nep_first_name" value="<?=(isset($result))? $result->nep_first_name:''?>"
                      maxlength="64" class="form-control" required placeholder="पहिलो नाम" id="id_nep_first_name" />
                  </div>
                  <div class="col-md-3 mb-sm-2">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-3 mb-sm-2">
                    <input type="text" name="eng_first_name" value="<?=(isset($result))? $result->eng_first_name:''?>"
                      maxlength="64" class="form-control" required placeholder="First Name" id="id_eng_first_name" />
                  </div>
                  <div class="col-md-3 mb-sm-2">
                    <input type="text" name="eng_middle_name" value="<?=(isset($result))? $result->eng_middle_name:''?>"
                      maxlength="64" class="form-control" placeholder="Middle Name" id="id_eng_middle_name" />
                  </div>
                  <div class="col-md-3 mb-sm-2">
                    <input type="text" name="eng_last_name" value="<?=(isset($result))? $result->eng_last_name:''?>"
                      maxlength="64" class="form-control" required placeholder="Last Name" id="id_eng_last_name" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group row">
                  ...
                  <div class="col-md-3 mb-sm-2">
                    <select name="p_district" class="form-control select2 district_selected" id="district_selected-2"
                      required>
                      <option value="" selected>जिल्ला</option>
                      <?php
          ...
          <div class="col-md-12">
            <h4>
              बुबाको विवरण (Father's Detail)<span>
                <div style="margin-left:3px"><input type="checkbox" id="buwa" />संरक्षक भए !!</div>
              </span>
            </h4>
            <hr style="border: 1px solid #adadad">
          </div>
        ...
        <div class="row mt-4">
          <div class="col-md-12">
            <h4>
              आमाको विवरण (Mother's Detail)<span>
                <div style="margin-left:3px"><input type="checkbox" id="aama" />संरक्षक भए !!</div>
              </span>
            </h4>
            <hr style="border: 1px solid #adadad">
          </div>

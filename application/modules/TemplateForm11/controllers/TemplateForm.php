...
class TemplateForm extends MX_Controller {
    ...
    public function print_template_form()
    {
       ...
       // pp($send);
        ...
        //pp($send['result']);
        $send['chalani_result'] = $result_chalani     = $this->Mdl_chalani->getByFormId($send['result']->form_id);
        $send['chalani_no']     = $send['chalani_result']->chalani_no;

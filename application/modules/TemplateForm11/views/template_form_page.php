               ...
               <?php echo form_open_multipart($action_page);?>
                       ...
                       <div class="col-md-6">
                           <div class="form-group row">
                               <label class="col-sm-4 col-form-label"><span
                                       class="float-right">आवेदकको नाम<span
                                       class="text-danger">&nbsp;*</span></span></label>
                               <div class="col-sm-8">
                                   <div class="input-group">
                                       <input type="text" name="applicant_name" class="form-control" required value="<?= isset($result) ? $result->applicant_name : ''?>"/>
                                   </div>
                               </div>
                           </div>
                       </div>
                   ...
                   <div class="row">
                       <div class="col-md-5">
                           <div class="form-group row">
                               <label class="col-sm-4 col-form-label"><span
                                       class="float-right">पत्रको किसिम<span
                                       class="text-danger">&nbsp;*</span></span></label>
                               <div class="col-sm-8">
                                   <div class="input-group">
                       ...
                       <div class="col-md-5">
                           <div class="form-group row">
                               <label class="col-sm-4 col-form-label"><span
                                       class="float-right">पत्रको विषय<span
                                       class="text-danger">&nbsp;*</span></span></label>
                                <div class="col-sm-8">
                                   <div class="input-group">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                           <div class="form-group row">
                               <label class="col-sm-4 col-form-label"><span
                                       class="float-right">सिफरिसिको पत्रको विषय<span
                                       class="text-danger">&nbsp;*</span></span></label>
                               <div class="col-sm-8">
                                   <div class="input-group">
                                       <input type="text" name="subject" class="form-control" id= "sletter_subject" required value="<?= isset($result) ? $result->content_sub : ''?>"/>
                                   </div>
                               </div>
                           </div>
                       </div>
                   ...
                   <div class="row">
                       <div class="col-md-12 mt-4">
                           <textarea id="content" name="content" class='form-control'><?= isset($result) ? $result->content : ''?></textarea>
                       </div>
                   </div>

<?php
    ...
    {
    $action_page = "asthai-basobas/create"; }
    if($this->uri->segment(2)=="edit")
    {
    $action_page = "asthai-basobas/edit/".$this->uri->segment(3);
    }
    ...
    $path           = base_url()."assets/documents/settlement/asthai_basobas/";
?>
            ...
            <div class="container-fluid ">
                <nav aria-label="breadcrumb" class="bg-shadow">
                    <ol class="breadcrumb px-3 py-2">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url()?>asthai-basobas/">अस्थायी बसोबास</a></li>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <?php echo form_open_multipart($action_page); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                ना.प्र.प.नं.<span class="text-danger">&nbsp;*</span>
                                            </span>

                                    </label>

                                        <div class="col-sm-8">
                                            <input type="text" name="citizenship_no" maxlength="32" class="form-control" required id="id_citizenship_no" value="<?=$result->citizenship_no?>" />
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="con_no" maxlength="32" class="form-control" required id="con_no" value="<?=$result->con_no?>" />
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                ना.प्र.प. जारी जिल्ला<span class="text-danger">&nbsp;*</span>
                                            </span>

                                    </label>

                                        <div class="col-sm-8">
                                            <select name="citizenship_district" class="form-control select2" required id="id_citizenship_district">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                ना.प्र.प. जारी मिति<span class="text-danger">&nbsp;*</span>
                                            </span>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="nepali_citizenship_date" maxlength="10" class="form-control" required id="nepaliDate5" value="<?= isset($result) ? $result->nepali_citizenship_date : ''?>" />
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                बसोबास सुरु गरेको मिति<span class="text-danger">&nbsp;*</span>
                                            </span>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="nepali_permission_date" maxlength="10" class="form-control" required id="nepaliDate6" value="<?= isset($result) ? $result->nepali_permission_date : ''?>"  />
                                            </div>
                                        </div>
                ...
                <input type="checkbox" name="same" id="same" style="margin-left:45px"> - आवेदक नै घरधनी
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                               घरधनीको नाम<span class="text-danger">&nbsp;*</span>
                                            </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="ghar_no" maxlength="32" class="form-control" id="id_ghar_no" value="<?= isset($result) ? $result->ghar_no : ''?>" />
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                                टोल<span class="text-danger">&nbsp;*</span>
                                            </span>

                                    </label>

                                        <div class="col-sm-8">
                                            <input type="text" name="tole" maxlength="64" class="form-control" required id="id_tole" value="<?= isset($result) ? $result->tole : ''?>"/>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="road" maxlength="128" class="form-control" required id="id_road" value="<?= isset($result) ? $result->road : ''?>" />
                                        </div>
...
<script>
    ...
    JQ(document).ready(function() {
        ...
        JQ(document).on("click","#same",function(){
            //alert("same");
            var id_applicant_name = JQ("#id_applicant_name").val();
              JQ("#id_owner_name").val(id_applicant_name);  
        });

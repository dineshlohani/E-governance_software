...
<div class="letter_print">
    ...
    <div class="text-center font-28" style="margin-top: 80px; margin-bottom: 80px;">
        <p style="font-size:26px;"><span style="border-bottom: 1px solid black; margin-bottom: 5px;"> <span class="red"> बिषय: </span> अस्थायी बसोबास सिफारिस ।</span>
        </p>
    </div>


    <div class="text-justify" style="text-indent: 100px">
       <p style="font-size:18px; text-align: justify;"> <?=$result->gender_spec?> <?= $result->applicant_name ?> <?= $local_body->name ?> वडा
                            नं <?= $ward->name ?>
                            ...
                            देखि अस्थायी बसोबास गर्दै आउनु भएको व्यहोरा सिफारिस साथ अनुरोध गरिन्छ । </p>

                        </div>

    <div class="mt-3  font-italic">
        <p style="font-size:18px; text-align: justify;">बसोबास गर्नेको ना. प्र. प. नं.: <?= $result->citizenship_no ?>
        जिल्ला:- <?= $citizenship_district->name ?> / जारी मिति: <?= $result->nepali_citizenship_date ?> </p>
    </div>

    <div class="text-center font-24 font-bold my-4">
        <p style="font-size:18px; text-align: justify;"><span>
            बसोबास स्थान
            </span>
        </p>
    </div>

            ...
            <div class="tab-content" id="nav-tabContent">
                            ...
                            <table class="table table-bordered my-4">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$result->gender_spec?> <?= $result->resident_name ?></td>
                                    </tr>
                                    <tr>
                                        <td>सम्पर्क नं </td>
                                        <td><?=$result->con_no?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?= $result->nepali_citizenship_date ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div class="row">
                                                ...
                                                ?>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>sthai-basobas/edit/<?= $result->id ?>/">सम्पादन
                                                        गर्नुहोस्</a>
                                                </div>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>sthai-basobas/darta/<?= $result->id ?>/">
                                                        दर्ता गर्नुहोस</a>
                                                </div>
                                                <?php
                                                    }
                                                ...
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>sthai-basobas/chalani/<?= $result->id ?>/">
                                                        चलानी गर्नुहोस</a>
                                                </div>
                                                <?php
                                                    }
                ...
                <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                    ...
                    <div class="text-right">
                        ...
                        <?php echo form_open(base_url().'sthai-basobas/print/'.$result->id ,'target="_blank"'); ?>
                    ...
                    <div class="letter">
                        ...
                        <div class="text-center font-28" style="margin-top: 70px; margin-bottom: 50px;">
                            <h4><span style="border-bottom: 1px solid black; margin-bottom: 5px;"> <span class="red"> बिषय: </span> स्थायी बसोबास सिफारिस ।</span>
                            </h4>
                        </div>
                        ...
                        <div class="mt-3  font-italic">
                            ...
                            मिति <?= $result->nepali_citizenship_date ?>
                        </div>

                        <div class="text-center   my-4">
                            <span style="border-bottom: 1px solid black; margin-bottom: 5px;">
                                बसोबास स्थान
                            </span>
                        </div>
                        <div>

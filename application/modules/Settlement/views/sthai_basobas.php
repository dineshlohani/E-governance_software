<?php
    ...
    {
    $action_page = "sthai-basobas/create";
    }
    if($this->uri->segment(2)=="edit")
    {
    $action_page = "sthai-basobas/edit/".$this->uri->segment(3);
    }
    ...
    $path           = base_url()."assets/documents/settlement/sthai_basobas/";
?>
            ...
            <div class="container-fluid ">
                <nav aria-label="breadcrumb" class="bg-shadow">
                    <ol class="breadcrumb px-3 py-2">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url()?>sthai-basobas">स्थायी बसोबास</a></li>
            ...
            <?php echo form_open_multipart($action_page);?>
                ...
                <div class="row mt-4">
                    <div class="col-md-12 mb-3">
                        <h4>
                            स्थाई बसोबास गर्ने व्यक्तिको विवरण
                        </h4>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                            <span class="float-right">
                                               निवेदकको नाम<span class="text-danger">&nbsp;* 
                                                </span>
                                            </span>
                                    </label>
                                    <label class="col-md-4 col-form-label">
                            ...
                            <div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                           <input type="text" name="resident_name" maxlength="128" class="form-control" required id="id_resident_name" value="<?= isset($result) ? $result->resident_name : ''?>" />
                                        </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="con_no" maxlength="32" class="form-control" required id="con_no" value="<?= isset($result) ? $result->con_no : ''?>" />
                                        </div>
                                </div>
                            </div>
                        </div>

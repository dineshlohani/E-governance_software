    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2">
                ...
                <li class="breadcrumb-item"><a href="/asthai-basobas/">अस्थायी बसोबास</a></li>
            ...
            <div class="tab-content" id="nav-tabContent">
                            ...
                            <table class="table table-bordered my-4">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?= $result->nepali_citizenship_date ?>(<?= $result->english_citizenship_date ?>)
                                        </td>
                                    </tr>

                                    <tr>
                                        <td>
                                            बसोबास सुरु गरेको मिति
                                        </td>
                                        <td>
                                            <?= $result->nepali_permission_date ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div class="row">
                                                ...
                                                ?>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-warning btn-submit mt-3 btn-block  " href="<?= base_url() ?>asthai-basobas/edit/<?= $result->id ?>/">सम्पादन
                                                        गर्नुहोस्</a>
                                                </div>
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit  mt-3 btn-block  " href="<?= base_url() ?>asthai-basobas/darta/<?= $result->id ?>/">
                                                        दर्ता गर्नुहोस</a>
                                                </div>
                                                <?php
                                                    }
                                                ...
                                                <div class="col-lg-6">
                                                    <a class="btn btn-success btn-submit mt-3 btn-block  " href="<?= base_url() ?>asthai-basobas/chalani/<?= $result->id ?>/">
                                                        चलानी गर्नुहोस</a>
                                                </div>
                                                <?php
                                                    }
                ...
                <div class="tab-pane fade" id="sifaris" role="tabpanel" aria-labelledby="nav-profile-tab" aria-expanded="false">
                    ...
                    <div class="text-right">
                        ...
                        <?php echo form_open(base_url().'asthai-basobas/print/'.$result->id ,'target="_blank"'); ?>
                    ...
                    <div class="letter">
                        ...
                        <!-- ----------------------Modal End-------------- -->
                        <div class="text-center font-28" style="margin-top: 70px; margin-bottom: 50px;">
                            <h4><span style="border-bottom: 1px solid black; margin-bottom: 5px;"> <span class="red"> बिषय: </span> अस्थायी बसोबास सिफारिस ।</span>
                            </h4>
                        </div>


                        <div class="text-justify" style="text-indent: 100px">
                            <?=$result->gender_spec?> <?= $result->applicant_name ?> <?= $local_body->name ?> वडा
                            नं <?= $ward->name ?>
                            (साबिकको ठेगाना <?= $old_place->name ?>) अन्तर्गत तल उल्लेखित स्थानमा
                            रहेको
                            घरधनी
                            <?=$result->gender_spec?> <?= $result->owner_name ?> को घरमा विगत
                            मिति <?= $result->nepali_permission_date ?>
                            देखि अस्थायी बसोबास गर्दै आउनु भएको व्यहोरा सिफारिस साथ अनुरोध गरिन्छ ।

                        </div>

                        <div class="mt-3 font-italic">
                            बसोबास गर्नेको ना. प्र. प. नं.: <?= $result->citizenship_no ?>
                            जिल्ला:- <?= $citizenship_district->name ?> / जारी मिति: <?= $result->nepali_citizenship_date ?>
                        </div>

                        <div class="text-center font-24 font-bold my-4">
                            <span>
                                बसोबास स्थान
                            </span>
                        </div>

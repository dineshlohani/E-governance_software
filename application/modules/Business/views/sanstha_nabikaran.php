...
{
    $action_page = "sanstha-nabikaran/create";
}
if($this->uri->segment(2)=="edit")
{
    $action_page = "sanstha-nabikaran/edit/".$this->uri->segment(3);
}
...
$path           = base_url()."assets/documents/business/sanstha_nabikaran/";
?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                     ...
                                     <div class="col-sm-8">
                                        <input type="text" name="org_name" maxlength="256" class="form-control" required id="id_org_name" value="<?= isset($result)? $result->org_name : ''?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label"><span
                                        class="float-right">दर्ता मिति<span
                                        class="text-danger">&nbsp;*</span></span></label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="nepali_date_1" maxlength="10" class="form-control" required id="nepaliDate5" value="<?= isset($result)? $result->nepali_date_1 : DateEngToNep(date('Y-m-d'))?>" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="old_new_address" class="form-control select2" required id="id_old_new_address">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="tole_name" maxlength="256" class="form-control" required id="id_tole_name" value="<?= isset($result)? $result->tole_name : ''?>" />
                                        </div>
                                    </div>
                                </div>
                            </div>

<?php
    ...
    {
    $action_page = "sanstha-darta-pramanpatra/create";
    }
    if($this->uri->segment(2)=="edit")
    {
    $action_page = "sanstha-darta-pramanpatra/edit/".$this->uri->segment(3);
    }
  ...
  <div class="container-fluid ">
    <nav aria-label="breadcrumb" class="bg-shadow">
      <ol class="breadcrumb px-3 py-2">
        ...
        <li class="breadcrumb-item"><a href="<?= base_url()?>sanstha-darta-pramanpatra/">संस्था दर्ता प्रमाणपत्र</a>
        </li>
    ...
    <div class="card">
      <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <div class="input-group">
                  <input type="text" name="nepali_date" maxlength="10" class="form-control" id="nepaliDate4"
            ...
            <div class="row">
                ...
                <div class="form-group row">
                  <label class="col-md-4 col-form-label">
                    <span class="float-right">
                      <strong>संस्थाको नाम </strong><span class="text-danger">&nbsp;*</span>
                    </span>

                  </label>

                  <div class="col-sm-8">
                    <input type="text" name="org_name" maxlength="128" class="form-control" required id="id_org_name"
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-md-4 col-form-label">
                    <span class="float-right">
                      <strong>बिषयगत क्षेत्र </strong><span class="text-danger">&nbsp;*</span>
                    </span>

                  </label>

                  <div class="col-sm-8">
                    <input type="text" name="subjected_area" maxlength="64" class="form-control" required
                      id="id_subjected_area" value="<?= isset($result) ? $result->subjected_area : ''?>" />
                  </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-md-4 col-form-label">
                    <span class="float-right">
                      <strong>दर्ता नं. </strong><span class="text-danger">&nbsp;*</span>
                    </span>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-md-4 col-form-label">
                    <span class="float-right">
                      <strong>दर्ता मिति </strong><span class="text-danger">&nbsp;*</span>
                    </span>
                  ...
                  <div class="col-sm-8">
                    <div class="input-group">
                      <input type="text" name="nepali_darta_miti" maxlength="10" class="form-control" required
                        id="nepaliDate5" value="<?= isset($result) ? $result->nepali_darta_miti : ''?>" />
              ...
              <div class="col-md-3 mb-sm-2">
                <select name="org_district" class="form-control district select2 district_selected" required
                  ...
                  <option value="<?= $district->id ?>" <?php
                                                if($result->org_district == $district->id)
                                                {
                                                    echo 'selected = "selected"';
                                                }
              ...
              <div class="col-md-3 mb-sm-2">
                <select name="org_local_body" class="form-control local-body select2 local_body_selected" required
                  ...
                  <option value="<?= $local->id ?>" <?php
                                                if($result->org_local_body == $local->id)
                                                {
                                                    echo 'selected = "selected"';
                                                }
                                              ?>><?= $local->name ?></option>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-md-4 col-form-label">
                    <span class="float-right">
                      <strong>ई-मेल </strong><span class="text-danger">&nbsp;*</span>
                    </span>

                  </label>

                  <div class="col-sm-8">
                    <input type="text" name="org_email" maxlength="254" class="form-control" required id="id_org_email"
                      value="<?= isset($result) ? $result->org_email : ''?>" />
                  </div>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-md-4 col-form-label">
                    <span class="float-right">
                      <strong>सम्पर्क फोन नं. </strong><span class="text-danger">&nbsp;*</span>
                    </span>

                  </label>

                  <div class="col-sm-8">
                    <input type="text" name="org_contact_no" maxlength="15" class="form-control" required
                      id="id_org_contact_no" value="<?= isset($result) ? $result->org_contact_no : ''?>" />
                  </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-md-4 col-form-label">
                    <span class="float-right">
                      <strong>स्वदेशी / विदेशी </strong><span class="text-danger">&nbsp;*</span>
                    </span>

                  </label>

                  <div class="col-sm-8">
                    <select name="nationality" class="form-control" required id="id_nationality">
                      ...
                      <option value="2" <?php
                                                      if(isset($result) && $result->nationality == 2){
                                                          echo 'selected ="selected"';
                                                      }
                                                  ?>> बिदेशी </option>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-md-5 col-form-label">
                    <span class="float-right">
                      <strong>कारोबार सुरु भएको मिति </strong><span class="text-danger">&nbsp;*</span>
                    </span>
                  ...
                  <div class="col-sm-7">
                    <div class="input-group">
                      <input type="text" name="nepali_transact_date" maxlength="10" class="form-control" required
                        id="nepaliDate6" value="<?= isset($result) ? $result->nepali_transact_date : ''?>" />
        ...
        <div class="row mt-4">
          <div class="col-md-12 mb-3">
            <h4>
              संचालक / अध्यक्ष / मुख्य व्यक्तिको विवरण
            </h4>
            <hr style="border: 1px solid #adadad">
          </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-md-4 col-form-label">
                    <span class="float-right">
                      <strong>नाम थर</strong><span class="text-danger">&nbsp;*
                      </span>
                    </span>
                  </label>
                  <div class="col-sm-8">
                    <input type="text" name="owner_name" maxlength="128" class="form-control" required
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="own_email" maxlength="254" class="form-control" required id="id_own_email"
                      value="<?= isset($result) ? $result->own_email : ''?>" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <div class="form-group row">
              ...
              <div class="col-md-2 mb-sm-2">
                <select name="own_state" class="form-control state select2 state_selected" required
                  id="state_selected-2">
                  <option value="">प्रदेश</option>
                  <?php foreach($states as $state): ?>
                  <option value="<?=$state->id?>" <?php
                                                    if($result->own_state == $state->id)
                                                    {
                                                        echo 'selected = "selected"';
                                                    }
                                                  ?>><?= $state->name?></option>
              ...
              <div class="col-md-3 mb-sm-2">
                <select name="own_district" class="form-control district select2 district_selected" required
                  id="district_selected-2">
                  <option value="">जिल्ला</option>
                  <?php foreach($districts as $district): ?>
                  <option value="<?=$district->id?>" <?php
                                                        if($result->own_district == $district->id)
                                                        {
                                                            echo 'selected = "selected"';
                                                        }
                                                  ?>><?= $district->name?></option>
              ...
              <div class="col-md-3 mb-sm-2">
                <select name="own_local_body" class="form-control local-body select2 local_body_selected" required
                  id="local_body_selected-2">
                  <option value="">गा.पा./न.पा </option>
                  <?php foreach($locals as $local): ?>
                  <option value="<?=$local->id?>" <?php
                                                        if($result->own_local_body == $local->id)
                                                        {
                                                            echo 'selected = "selected"';
                                                        }
                                                  ?>><?= $local ->name?></option>
              ...
              <div class="col-md-2 mb-sm-2">
                <select name="own_ward" class="form-control ward-no select2 ward_selected" required
                  id="ward_selected-2">
                  <option value="">वडा नं</option>
                  <?php foreach($wards as $ward): ?>
                  <option value="<?=$ward->id?>" <?php
                                                        if($result->own_ward == $ward->id)
                                                        {
                                                            echo 'selected = "selected"';
                                                        }
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="own_contact_no" maxlength="15" class="form-control" required
                      id="id_own_contact_no" value="<?= isset($result) ? $result->own_contact_no : ''?>" />
                  </div>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="cit_no" maxlength="15" class="form-control" required id="cit_no"
